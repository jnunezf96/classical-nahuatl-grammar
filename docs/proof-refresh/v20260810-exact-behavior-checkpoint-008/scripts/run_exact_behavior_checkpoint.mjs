...
const version = "v20260810-exact-behavior-checkpoint-008";
...
const testFiles = ["classical_checkpoint008_role_exact.test.js"];
...
assert(captured.size === 50, `checkpoint exact project-role observation yield drifted: ${captured.size}`);
...
assert(progress.lessonCorpus.exactProofs.exactBehaviorObserved === 5756, "progress ledger delta is wrong");
const report = { schemaVersion: 1, version, status: "passed",
  ...
  progress: { denominator: 18639, before: 5706, after: 5756, remaining: 12883 },
