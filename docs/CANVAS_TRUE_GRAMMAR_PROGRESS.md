...
| lessonGrammarExactBehaviorObserved | 8358 | 18639 | 44.84% | incomplete |
...
Lessons 1–58 contain **18,639** grammar-bearing atoms. All have owner links, but only **8,358** currently have an acceptable exact-behavior observation.

The remaining **10,281** use non-generative assertion coordinates where the canonical engine must instead be observed performing, deriving, projecting, enforcing, constructing, or validating the atom-specific behavior.
