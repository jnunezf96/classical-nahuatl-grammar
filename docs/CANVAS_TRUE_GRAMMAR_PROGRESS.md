...
| lessonGrammarExactBehaviorObserved | 6756 | 18639 | 36.25% | incomplete |
...
Lessons 1–58 contain **18,639** grammar-bearing atoms. All have owner links, but only **6,756** currently have an acceptable exact-behavior observation.

The remaining **11,883** use non-generative assertion coordinates where the canonical engine must instead be observed performing, deriving, projecting, enforcing, constructing, or validating the atom-specific behavior.
