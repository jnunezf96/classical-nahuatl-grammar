...
const EXACTLY_IMPLEMENTED_WRITING_ATOMS = Object.freeze({
  ...
  ...Object.fromEntries([
    ...
    "ACI-P049-L020-2762BDE311-05", "ACI-P049-L020-2762BDE311-06",
    "ACI-P049-L020-2762BDE311-07", "ACI-P049-L020-2762BDE311-08",
    "ACI-P049-L020-2762BDE311-09", "ACI-P049-L020-2762BDE311-10",
    "ACI-P049-L030-AF1F6BDC65", "ACI-P049-L030-AF1F6BDC65-02",
    "ACI-P049-L030-AF1F6BDC65-03", "ACI-P049-L030-AF1F6BDC65-04",
    "ACI-P049-L030-AF1F6BDC65-05", "ACI-P049-L030-AF1F6BDC65-06",
    "ACI-P049-L030-AF1F6BDC65-07", "ACI-P049-L030-AF1F6BDC65-08",
    "ACI-P049-L030-AF1F6BDC65-09", "ACI-P049-L030-AF1F6BDC65-10",
    "ACI-P049-L030-AF1F6BDC65-11", "ACI-P049-L030-AF1F6BDC65-12",
    "ACI-P049-L030-AF1F6BDC65-13", "ACI-P049-L030-AF1F6BDC65-14",
    "ACI-P049-L030-AF1F6BDC65-15", "ACI-P049-L030-AF1F6BDC65-16",
    "ACI-P049-L030-AF1F6BDC65-17", "ACI-P049-L036-567BAC1121",
    "ACI-P049-L037-714FF652AC",
  ].map(atomId => [atomId, Object.freeze({
    observationKind: "regressive-assimilation-example-normal-application-result",
    observationTest: `src/tests/classical_lesson2_regressive_examples_jobs.test.js#${atomId}`,
    mutationTest: `src/tests/classical_lesson2_regressive_examples_jobs.test.js#${atomId}-changed-behavior-fails`,
  })])),
  ...Object.fromEntries([
  ...
  ...Object.fromEntries([
    ...
    "ACI-P043-L004-F2E29DEABA", "ACI-P043-L009-8A8A8CF899",
    "ACI-P043-L010-2CCAB7C51B", "ACI-P043-L019-15C0490C69",
    "ACI-P043-L020-A07915A2FD", "ACI-P043-L020-A07915A2FD-02",
    "ACI-P043-L027-98A44BD022-02", "ACI-P043-L034-AB18229A6C",
    "ACI-P043-L038-8B0190F494", "ACI-P043-L039-3329EAB5F5",
    "ACI-P044-L004-D360BDABAF", "ACI-P044-L005-D667DCBE75",
    "ACI-P044-L008-C4AD6FC5E4", "ACI-P044-L009-A973F5B96F",
    "ACI-P044-L009-A973F5B96F-02", "ACI-P044-L011-8D096DB6AB",
    "ACI-P044-L012-80135184B8", "ACI-P044-L014-144263341A",
    "ACI-P044-L017-D45B9DF812", "ACI-P044-L017-2985B8B7F5",
    "ACI-P044-L019-A1ABA633CB", "ACI-P044-L021-561E724BF9",
    "ACI-P044-L023-01709339AE", "ACI-P044-L024-9D5908F96D",
    "ACI-P044-L025-8730E52478", "ACI-P044-L029-4CEF656946",
    "ACI-P044-L034-DCC310EE8E", "ACI-P044-L036-68347FAA55",
    "ACI-P044-L038-2D143BDBE9", "ACI-P044-L039-D582A407B2",
    "ACI-P045-L006-172CAF6951", "ACI-P045-L008-A9CE40A048",
    "ACI-P045-L009-59162348AA", "ACI-P045-L010-20552CDB77",
    "ACI-P045-L011-5FE4F29714", "ACI-P045-L012-5A5BF547DB",
    "ACI-P045-L013-E5A3BAC717", "ACI-P045-L014-1EE4F3B953",
    "ACI-P045-L015-896059A9A2-03", "ACI-P045-L019-700DDA618F",
    "ACI-P045-L020-F601244A8E", "ACI-P045-L021-356443CB33",
    "ACI-P045-L025-E803B9B8AC", "ACI-P045-L026-3EB969809B",
    "ACI-P045-L026-3EB969809B-02", "ACI-P045-L026-3EB969809B-03",
    "ACI-P045-L028-04AAC6D1B7", "ACI-P045-L034-7609BEDD16",
  ].map(atomId => [atomId, Object.freeze({
    observationKind: "fricative-stop-or-affricate-normal-application-result",
    observationTest: `src/tests/classical_lesson2_fricative_stop_affricate_jobs.test.js#${atomId}`,
    mutationTest: `src/tests/classical_lesson2_fricative_stop_affricate_jobs.test.js#${atomId}-changed-behavior-fails`,
  })])),
  ...Object.fromEntries([
