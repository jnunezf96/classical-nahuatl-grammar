...
const ANDREWS_TRAJECTORY_GROUPS = Object.freeze([
    {
        ...
        validationRefs: ["src/tests/registry.test.js", "src/tests/concepts.test.js", "src/tests/classical_firewall.test.js", "src/tests/particles.test.js", "src/tests/clause.test.js"],
    },
    {
        range: [5, 11],
        ...
        validationRefs: ["src/tests/registry.test.js", "src/tests/agreement.test.js", "src/tests/classical_vnc_application.test.js", "src/tests/classical_lesson7_typed_source_authority.test.js", "src/tests/sentence.test.js", "src/tests/irregulars.test.js"],
    },
    {
        range: [12, 19],
    ...
    },
    {
        ...
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_vnc_derivation_canvas_authority_retirement.test.js", "src/tests/classical_vnc_application.test.js", "src/tests/agreement.test.js"],
    },
    {
        range: [28, 34],
    ...
    },
    {
        ...
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_vnc_derivation_canvas_authority_retirement.test.js", "src/tests/classical_lessons40_43_closure.test.js", "src/tests/modification.test.js"],
    },
    {
        range: [44, 50],
        ...
        validationRefs: ["src/tests/registry.test.js", "src/tests/adverbial.test.js", "src/tests/classical_lessons49_50_closure.test.js"],
    },
    {
        range: [51, 58],
...
const ANDREWS_FOUNDATION_TRAJECTORY_OVERRIDES = Object.freeze({
    1: {
        ...
        plannedArrows: [
            ...
            },
            {
                ...
                aim: "Aplicar Corrección antes de existencia: auditar Andrews Lección 1 por la ruta de entrada a salida como comportamiento de notación de fórmula, con sonda de fallo para detectar existencia de símbolos #, paréntesis, + o guion tratados como superficie Classical Nahuatl y no como contrato de motor.",
                andrewsRefs: ["Andrews Lesson 1"],
                expectedFeedbackRefs: ["src/tests/registry.test.js", "src/tests/concepts.test.js"],
            },
        ],
        firedArrows: [
            ...
            },
            {
                id: "lesson-1-formula-authority-audit",
                result: "hit",
                correction: "Corrección antes de existencia: la notación de fórmula de Andrews queda como comportamiento de contrato en la ruta de entrada a salida; la sonda de fallo contra existencia sola es que #, paréntesis, + o guion se traten como superficie Classical Nahuatl o licencia de generación.",
                andrewsRefs: ["Andrews Lesson 1"],
                feedbackRefs: ["src/tests/registry.test.js", "src/tests/concepts.test.js"],
            },
        ],
    ...
    2: {
        canvasRefs: ["Andrews Lesson 2.1-2.16"],
        directive: "Usa Andrews Lección 2 para las categorías clásicas de sonido y escritura, y luego enruta las superficies por el realización clásica contextual Classical Nahuatl antes de cualquier realización Classical Nahuatl.",
        implementationState: "partial",
        redirectAction: "source-gated",
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-required",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_firewall.test.js"],
        plannedArrows: [
            {
                id: "lesson-2-subsection-coverage-audit",
                type: "metadata-diagnostic-test",
                aim: "Aplicar Corrección antes de existencia: auditar Andrews Lección 2.1-2.16 por la ruta de entrada a salida como comportamiento de sonido, escritura y realización clásica contextual, con sonda de fallo para detectar un puente existente que confunda -h de núm2, saltillo silábico o evidencia léxica Classical Nahuatl.",
                andrewsRefs: ["Andrews Lesson 2.1-2.16"],
                expectedFeedbackRefs: ["src/tests/classical_firewall.test.js", "docs/GRAMMAR_SPEC.md"],
            },
            {
                id: "lesson-2-formula-orthography-authority-audit",
                type: "orthography-formula-test",
                aim: "Aplicar Corrección antes de existencia: auditar Andrews Lección 2 por la ruta de entrada a salida como comportamiento de realización clásica contextual subordinado a ranuras de fórmula, con sonda de fallo para detectar conversión existente que cambie dueño de ranura, trate h de núm2 como j glotal o trate h silábica final como t de núm2.",
                andrewsRefs: ["Andrews Lesson 2.1-2.16"],
                expectedFeedbackRefs: ["src/tests/classical_firewall.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            {
                ...
                andrewsRefs: ["Andrews Lesson 2.1-2.16"],
                feedbackRefs: ["src/tests/classical_firewall.test.js", "docs/GRAMMAR_SPEC.md"],
            },
            {
                id: "lesson-2-formula-orthography-authority-audit",
                result: "hit",
                correction: "Corrección antes de existencia: el realización clásica contextual de Andrews queda subordinado a ranuras de fórmula como comportamiento verificable en la ruta de entrada a salida; la sonda de fallo contra existencia sola es h de núm2 como j glotal, h final silábica como t de núm2, o conversión que cambie dueño de ranura.",
                andrewsRefs: ["Andrews Lesson 2.1-2.16"],
                feedbackRefs: ["src/tests/classical_firewall.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
    ...
    3: {
        canvasRefs: ["Andrews Lesson 3"],
        directive: "Usa Andrews Lección 3 para clasificar partículas como unidades menores sensibles a colocación; mantener modo Partícula como diagnóstico salvo que evidencia local Classical Nahuatl confirme superficies y funciones.",
        implementationState: "partial",
    ...
    4: {
        canvasRefs: ["Andrews Lesson 4.1-4.6"],
    ...
    5: {
        ...
        directive: "Usa Andrews Lección 5 para dirigir la fórmula intransitiva de cláusula verbal, la distribución de la posición del pronombre de sujeto, el inventario de morfemas de tiempo y el límite de realización Classical Nahuatl.",
        implementationState: "implemented-audited",
        redirectAction: "keep",
        ...
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_vnc_application.test.js"],
        plannedArrows: [
            {
                id: "lesson-5-intransitive-vnc-audit",
                type: "metadata-engine-test",
                aim: "Aplicar Corrección antes de existencia: auditar Andrews Lección 5.1-5.5 por la ruta de entrada a salida como comportamiento de fórmula de cláusula verbal intransitiva, posiciones de sujeto, rutas de tiempo y realización clásica contextual Classical Nahuatl, con sonda de fallo para detectar superficie optativa shi con metadatos pers1 todavía ti o an.",
                andrewsRefs: ["Andrews Lesson 5.1-5.5"],
                expectedFeedbackRefs: ["src/tests/classical_vnc_application.test.js", "docs/GRAMMAR_SPEC.md"],
            },
            {
    ...
    6: {
        ...
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_vnc_application.test.js", "src/tests/agreement.test.js", "src/tests/combo_validation.test.js"],
        plannedArrows: [
            {
                id: "lesson-6-transitive-vnc-audit",
                type: "metadata-engine-test",
                aim: "Aplicar Corrección antes de existencia: auditar Andrews Lección 6.1-6.7 por la ruta de entrada a salida como comportamiento de valencia transitiva, categorías de objeto y realización Classical Nahuatl, con sonda de fallo para detectar metadatos que existan sin separar valencia monádica, diádica, específica, inespecífica y reflexiva.",
            ...
            },
            {
                ...
                type: "formula-engine-test",
                aim: "Aplicar autoridad de fórmula de Andrews: verificar por la ruta de entrada a salida que ne de línea secundaria conserve fórmula monádica y genere como Classical Nahuatl directo; la sonda de fallo es bloquear ne o un metadato que lo llame mu de línea principal.",
                andrewsRefs: ["Andrews Lesson 6.1-6.7"],
                expectedFeedbackRefs: ["src/tests/classical_vnc_application.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            ...
            },
            {
                id: "lesson-6-shuntline-ne-direct-generation-audit",
                result: "hit",
                correction: "Corrección antes de existencia: ne de línea secundaria queda como fórmula monádica activa por la ruta de entrada a salida; la sonda de fallo contra existencia sola es bloquear la superficie Classical Nahuatl ne o confundirla con mu de línea principal.",
                andrewsRefs: ["Andrews Lesson 6.1-6.7"],
                feedbackRefs: ["src/tests/classical_vnc_application.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
    ...
    7: {
        ...
        evidenceStatus: "direct-source-with-classical-realization",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_vnc_application.test.js", "src/tests/classical_lesson7_typed_source_authority.test.js"],
        plannedArrows: [
            {
    ...
    8: {
        ...
        remainingGap: "Siguen solo diagnósticas o pendientes de evidencia: generación oracional, realización confirmada de partículas Classical Nahuatl de la Lección 8 y controles generativos de prefijos direccionales/locativos de cláusula verbal.",
    },
    9: {
        ...
        remainingGap: "Siguen solo diagnósticas o pendientes de evidencia: generación oracional, realización confirmada de partículas Classical Nahuatl de la Lección 9 y semántica oracional optativa/mandato dirigida por Andrews.",
    },
    10: {
        ...
        remainingGap: "Siguen solo diagnósticas o pendientes de evidencia: generación oracional, realización confirmada de partículas Classical Nahuatl de la Lección 10 y semántica oracional admonitiva/optativa dirigida por Andrews.",
    },
    11: {
        canvasRefs: ["Andrews Lesson 11.1-11.6"],
        directive: "Usa Andrews Lección 11 para dirigir la taxonomía irregular de cláusula verbal: irregularidad de tronco perfectivo, dislocación entre forma de tiempo y significado, paradigmas defectivos, supleción y límites idiomáticos; mantener las superficies Classical Nahuatl sujetas a evidencia.",
        implementationState: "partial",
        redirectAction: "source-gated",
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        ...
        firedArrows: [
            {
                id: "lesson-11-irregular-vnc-audit",
                result: "hit",
                correction: "La Lección 11 ahora lleva referencias de PDF por subsección, directivas en español, taxonomía irregular de tronco perfectivo, metadatos de dislocación forma de tiempo/significado, marcos de supleción, límites idiomáticos y bloqueos explícitos contra generación irregular clásica-a-Classical Nahuatl no licenciada.",
                andrewsRefs: ["Andrews Lesson 11.1-11.6"],
                feedbackRefs: ["src/tests/irregulars.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        remainingGap: "El subconjunto supletivo Classical Nahuatl actual está implementado, pero siguen solo diagnósticas o pendientes de evidencia: taxonomía irregular completa de tronco perfectivo de Andrews, dislocaciones forma de tiempo/significado, paradigmas defectivos y modismos.",
    },
    12: {
    ...
    16: {
        ...
        remainingGap: "Siguen parciales o pendientes de evidencia: ejemplos Classical Nahuatl confirmados de cláusula nominal pronominal, contrato seguro de ruta pronominal, manejo de ortografía fusionada, alomorfía de matriz cuantitativa y comportamiento de suplementación/función adjetival.",
    },
    17: {
        ...
        remainingGap: "Siguen parciales o pendientes de evidencia: ejecución de AST de suplementación, ejemplos confirmados de cláusulas Classical Nahuatl, controles de interfaz de tópico/comentario, resolución de ambigüedad recursiva y generación de preguntas de información.",
    },
    18: {
    ...
    20: {
        ...
        directive: "Usa Andrews Lección 20 para dirigir la derivación de tronco verbal no activo: selección de fuente activa imperfectiva, familias de sufijos u/lu/wa y combinaciones, realización Classical Nahuatl u/lu/wa/uwa/luwa/walu, límites de excepción y rutas de Clase A-2.",
        implementationState: "implemented-audited",
        redirectAction: "keep",
        evidenceStatus: "direct-source-with-classical-realization",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_vnc_derivation_canvas_authority_retirement.test.js", "docs/GRAMMAR_SPEC.md"],
        plannedArrows: [
            {
                id: "lesson-20-nonactive-verbstem-audit",
                type: "metadata-engine-test",
                aim: "Auditar Andrews Lección 20.1-20.8 contra las familias actuales de sufijos no activos Classical Nahuatl, selección de fuente activa imperfectiva, correspondencias de sufijo, límites de excepción y rutas de Clase A-2.",
                andrewsRefs: ["Andrews Lesson 20.1-20.8"],
                expectedFeedbackRefs: ["src/tests/classical_vnc_derivation_canvas_authority_retirement.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            {
                id: "lesson-20-nonactive-verbstem-audit",
                result: "hit",
                correction: "La Lección 20 ahora lleva referencias de PDF por subsección, directivas en español, metadatos de puente para familias de sufijos Classical Nahuatl, límites de tronco fuente, familias actuales de opción del motor y evidencia de rutas de Clase A-2.",
                andrewsRefs: ["Andrews Lesson 20.1-20.8"],
                feedbackRefs: ["src/tests/classical_vnc_derivation_canvas_authority_retirement.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        remainingGap: "none",
    },
    21: {
        ...
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_vnc_application.test.js", "docs/GRAMMAR_SPEC.md"],
        plannedArrows: [
            {
        ...
        firedArrows: [
            {
                id: "lesson-21-passive-voice-audit",
                result: "hit",
                correction: "La Lección 21 ahora registra la transformación pasiva de Andrews, el inventario de casos 21.2, soporte actual de anulación de sujeto pasivo Classical Nahuatl, deriva combinada pasiva/impersonal y brechas explícitas antes de reclamar pase más cercano.",
                andrewsRefs: ["Andrews Lesson 21.1-21.4"],
                feedbackRefs: ["src/tests/classical_vnc_application.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
    ...
    23: {
        ...
        directive: "Usa Andrews Lección 23 para dirigir la arquitectura de objetos verbales: clases de objeto directivo, causativo y aplicativo; posiciones múltiples de valencia; niveles de objeto de línea principal y línea desviada; morfemas silenciosos; prioridades de secuencia de objeto; y adaptación ortográfica Classical Nahuatl para marcadores de objeto.",
        implementationState: "partial",
        redirectAction: "refactor-engine",
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        ...
        plannedArrows: [
            {
                ...
                type: "metadata-engine-test",
                aim: "Auditar Andrews Lección 23.1-23.5 contra las posiciones actuales de objeto, metadatos de función de objeto, posiciones de línea principal/línea desviada, morfemas silenciosos, prioridades de secuencia y realización clásica contextual Classical Nahuatl.",
        ...
        remainingGap: "Siguen parciales o pendientes de evidencia: ambigüedad de función de objeto, contratos discontinuos de objeto-más-sufijo, historias completas de línea principal/línea desviada, tablas de morfemas silenciosos, las trece combinaciones de objeto de Andrews, inventario del Apéndice C y excepciones Classical Nahuatl.",
    },
    24: {
        ...
        plannedArrows: [
            {
                ...
                type: "metadata-engine-test",
                aim: "Auditar Andrews Lección 24.1-24.9 contra la generación causativa actual de primer tipo, límites neutrales de valencia, arquitectura de tronco desacerval, transformaciones de sujeto fuente a objeto y evidencia ortográfica Classical Nahuatl.",
    ...
    27: {
        ...
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_vnc_lessons27_29_33_closure.test.js", "docs/GRAMMAR_SPEC.md"],
        plannedArrows: [
            {
                ...
                expectedFeedbackRefs: ["src/tests/classical_vnc_lessons27_29_33_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            {
    ...
    31: {
        ...
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_lessons30_34_closure.test.js", "docs/GRAMMAR_SPEC.md"],
        plannedArrows: [
            {
                ...
                expectedFeedbackRefs: ["src/tests/classical_lessons30_34_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            {
                ...
                andrewsRefs: ["Andrews Lesson 31.1-31.13"],
                feedbackRefs: ["src/tests/classical_lessons30_34_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        remainingGap: "Siguen parciales o pendientes de evidencia: generación de troncos nominales compuestos, análisis compuesto específico de cláusula nominal, segmentación enlazada/sin conectivo/integrada, orientación de poseedor, alomorfía de clase de incrustación, rellenadores únicos, clases de matriz ka/yu, compuestos conjuntivos, compuestos recursivos, patrones de sexo/progenie/compañerismo, troncos de afinidad, troncos distributivos/varietales y ejemplos Classical Nahuatl confirmados.",
    },
    32: {
    ...
    34: {
        ...
        remainingGap: "Siguen parciales o pendientes de evidencia: generación de numerales cardinales, troncos numerales básicos, rutas de conteo grueso, formaciones excepcionales de conteo grueso en estado posesivo, matrices compuestas de orden alto, estructuras numerales conjuntadas, conjuntos clasificadores, reduplicación, modificadores aproximativos/de más, cláusulas nominales de medida y ejemplos Classical Nahuatl confirmados.",
    },
    35: {
        ...
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_nnc_lessons35_39_closure.test.js", "docs/GRAMMAR_SPEC.md"],
        plannedArrows: [
            {
                ...
                expectedFeedbackRefs: ["src/tests/classical_nnc_lessons35_39_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            {
                ...
                andrewsRefs: ["Andrews Lesson 35.1-35.12"],
                feedbackRefs: ["src/tests/classical_nnc_lessons35_39_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        remainingGap: "Siguen parciales o pendientes de evidencia: generación agentiva de pretérito completa, alternancias de posición de número, selección de tronco de afinidad, híbridos activados de objeto proyectivo, límites léxicos de persona anciana, absolutivos raros con matriz que, selección completa de subclases de posesión e/wa/yua, matrices adverbiales centradas en objeto, excepciones reflexivas lexicalizadas y ejemplos Classical Nahuatl confirmados.",
    },
    36: {
    ...
    40: {
        ...
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_lessons40_43_closure.test.js", "docs/GRAMMAR_SPEC.md"],
        plannedArrows: [
            {
                ...
                expectedFeedbackRefs: ["src/tests/classical_lessons40_43_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            {
    ...
    47: {
        ...
        remainingGap: "Siguen parciales o pendientes de evidencia: generación relacional nominal, datos estáticos relacionales, confirmación ortográfica Classical Nahuatl, verificación ortográfica visible por posición, análisis de poseedor suplementario, incrustación pa/copa, compuestos relacionales con t conectiva, distinciones de compuestos de parte corporal, contraste entidad asociada frente a gentilicio, enrutamiento de pertinencia, detección de analizador/búsqueda, acciones visibles de interfaz y ejemplos Classical Nahuatl confirmados.",
    },
    48: {
        canvasRefs: ["Andrews Lesson 48.1-48.13"],
        directive: "Usa Andrews Lección 48 para dirigir la arquitectura de nombres de lugar y gentilicios nominales: referencia única de nombre de lugar adverbializado, siete grupos de nombres de lugar, cuatro rutas de formación gentilicia, ambigüedad ortográfica, incorporación, uso gentilicio adjetival, colectividad, extensiones de profesión/título y bloqueo de superficies Classical Nahuatl guiadas por traducción o sin evidencia.",
        implementationState: "partial",
        redirectAction: "source-gated",
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "contextual-classical-realization-plus-source-gate-required",
        ...
        plannedArrows: [
            {
                ...
                expectedFeedbackRefs: ["src/tests/classical_lessons49_50_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            {
                ...
                andrewsRefs: ["Andrews Lesson 49.1-49.10"],
                feedbackRefs: ["src/tests/classical_lessons49_50_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
    ...
    51: {
        ...
        directive: "Usa Andrews Lección 51 para dirigir la arquitectura de complementación: estructuras de complemento de doble núcleo, complementos de objeto, complementos de sujeto, complementos adverbiales, enlaces pronominales compartidos, transformaciones pasivas de complemento de objeto, complementos relacionales lexicalizados y bloqueo continuo de superficies Classical Nahuatl sin evidencia.",
        implementationState: "partial",
        redirectAction: "diagnostic-only",
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "not-surface-bearing",
        validationRefs: ["src/tests/registry.test.js", "src/tests/classical_lessons51_52_closure.test.js", "docs/GRAMMAR_SPEC.md"],
        plannedArrows: [
            {
                ...
                expectedFeedbackRefs: ["src/tests/classical_lessons51_52_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
        firedArrows: [
            {
                ...
                andrewsRefs: ["Andrews Lesson 51.1-51.4"],
                feedbackRefs: ["src/tests/classical_lessons51_52_closure.test.js", "docs/GRAMMAR_SPEC.md"],
            },
        ],
    ...
    53: {
        ...
        directive: "Usa exclusivamente la transcripción Canvas de Andrews en ANDREWS_TRANSCRIPTION_CANVAS.md Lección 53 para ejecutar una sola ruta tipada de fuente, operación semántica, AST y resultado que cubre todas las distinciones de semejanza, igualdad, tamaño, comparativo, pregunta de cuánto más y superlativo sin convertir ejemplos almacenados en autoridad.",
        implementationState: "implemented-audited",
        redirectAction: "keep",
        evidenceStatus: "canvas-source-verified",
        orthographyStatus: "classical-canonical-realization",
        validationRefs: ["src/tests/registry.test.js", "src/tests/comparison.test.js"],
        plannedArrows: [
            {
                id: "lesson-53-comparison-closure",
                type: "typed-grammar-and-hostile-proof",
                aim: "Proyectar todas las distinciones de Lección 53 por una sola operación tipada y un solo resultado canónico, con prueba exhaustiva de fuente y hostilidad.",
                andrewsRefs: ["Andrews Lesson 53.1-53.7", "ANDREWS_TRANSCRIPTION_CANVAS.md 53.1-53.7"],
                expectedFeedbackRefs: ["src/tests/comparison.test.js"],
            },
        ],
        firedArrows: [
            {
                id: "lesson-53-comparison-closure",
                result: "hit",
                correction: "La Lección 53 ejecuta 23 rutas semánticas mediante una sola operación tipada, AST y resultado seleccionado; el inventario y los ejemplos de Canvas permanecen evidencia no autorizante.",
                andrewsRefs: ["Andrews Lesson 53.1-53.7", "ANDREWS_TRANSCRIPTION_CANVAS.md 53.1-53.7"],
                feedbackRefs: ["src/tests/comparison.test.js"],
            },
        ],
        remainingGap: "none",
    },
        ...
        plannedArrows: [
            {
                ...
                type: "metadata-engine-test",
                aim: "Auditar Andrews Lección 54.1-54.6 contra el inventario actual de contratos denominales, contratos de regla ejecutable, compuertas de evidencia de fuente, realización clásica contextual y bloqueos de generación finita.",
        ...
        plannedArrows: [
            {
                ...
                type: "metadata-engine-test",
                aim: "Auditar Andrews Lección 55.1-55.7 contra el inventario actual de contratos denominales, contratos de regla ejecutable, compuertas de evidencia de fuente, realización clásica contextual, soporte actual de rutas i-hui/a-hui y bloqueos de generación finita.",
    ...
    56: {
        ...
        directive: "Usa la GCD tipada de nombre personal de Andrews para degradar una cláusula o unidad completa a tallo predicativo, conservar sujetos y predicados internos, y formar la cláusula nominal nuclear absolutiva externa con número Ø-Ø; conserva la LCM completa de fuentes simples, adjunción, calendario, conjunción, uso oracional y reranking.",
        implementationState: "implemented-audited",
        redirectAction: "keep",
        evidenceStatus: "canvas-source-span-complete",
        orthographyStatus: "typed-boundary-realization",
        validationRefs: ["src/tests/fixtures/classical_lesson56_source_ledger.js", "src/tests/nnc_names.test.js"],
        plannedArrows: [
            {
                id: "lesson-56-personal-name-nnc-exhaustive-closure",
                type: "typed-grammar-source-span-test",
                aim: "Probar cada familia de fuente, eje LCM, operación oracional, coordenada escalar/paradigma y frontera hostil contra el tramo exacto de Lección 56 del Canvas.",
                andrewsRefs: ["Andrews Lesson 56.1-56.5", "ANDREWS_TRANSCRIPTION_CANVAS.md:24065-24704"],
                expectedFeedbackRefs: ["src/tests/fixtures/classical_lesson56_source_ledger.js", "src/tests/nnc_names.test.js"],
            },
        ],
        firedArrows: [
            {
                id: "lesson-56-personal-name-nnc-exhaustive-closure",
                result: "hit",
                correction: "La Lección 56 ejecuta una sola operación tipada para sus veinte familias de fuente, conserva veinte ejes LCM y ocho operaciones oracionales/reranking, y rechaza autoridad de fórmulas, superficies, etiquetas y fixtures.",
                andrewsRefs: ["Andrews Lesson 56.1-56.5", "ANDREWS_TRANSCRIPTION_CANVAS.md:24065-24704"],
                feedbackRefs: ["src/tests/fixtures/classical_lesson56_source_ledger.js", "src/tests/nnc_names.test.js"],
            },
        ],
        remainingGap: "",
    },
    57: {
        ...
        directive: "Integra cada regla de Andrews en su dueño canónico compartido: resultado finito de cláusula nuclear verbal para tiempo contextual, fuente léxica para valencia, suplementación para relaciones de cláusula y primera persona silenciosa, y cláusula nuclear nominal ordinaria para troncos en l. El contexto y los inventarios cerrados son hechos tipados, nunca autoridad curricular o textual.",
        implementationState: "implemented-audited",
        redirectAction: "keep",
        evidenceStatus: "canvas-source-span-complete",
        orthographyStatus: "typed-boundary-realization",
        validationRefs: ["src/tests/fixtures/classical_lessons57_58_source_ledger.js", "scripts/audit_classical_lessons57_58_source_spans.js", "src/tests/analysis.test.js"],
        plannedArrows: [
            {
                id: "lesson-57-canonical-owner-exhaustive-closure",
                type: "typed-grammar-source-span-test",
                aim: "Probar cada regla mediante su cláusula nuclear verbal, cláusula nuclear nominal u operación de suplementación compartida, la paridad escalar/paradigma aplicable y la frontera hostil contra el tramo exacto de Lección 57 del Canvas.",
                andrewsRefs: ["Andrews Lesson 57.1-57.7", "ANDREWS_TRANSCRIPTION_CANVAS.md:24705-25018"],
                expectedFeedbackRefs: ["src/tests/fixtures/classical_lessons57_58_source_ledger.js", "src/tests/analysis.test.js"],
            },
        ],
        firedArrows: [
            {
                id: "lesson-57-canonical-owner-exhaustive-closure",
                result: "hit",
                correction: "La Lección 57 no crea un motor de análisis: cada regla llega al dueño canónico de cláusula nuclear verbal, cláusula nuclear nominal o suplementación, con resultados emitidos por el dueño y rechazo de marcos clonados, fórmulas, superficies y metadatos de lección como autoridad.",
                andrewsRefs: ["Andrews Lesson 57.1-57.7", "ANDREWS_TRANSCRIPTION_CANVAS.md:24705-25018"],
                feedbackRefs: ["src/tests/fixtures/classical_lessons57_58_source_ledger.js", "src/tests/analysis.test.js"],
            },
        ],
        remainingGap: "",
    },
    58: {
        ...
        directive: "Integra las reglas de Andrews para el inventario instrumental az en cláusula nuclear nominal ordinaria y cláusula nuclear verbal denominal, las construcciones cerradas y el papel del nombre incorporado en el dueño de construcción nominal, y la exclamación y mah en suplementación; los problemas textuales quedan solo como evidencia documental de prueba.",
        implementationState: "implemented-audited",
        redirectAction: "keep",
        evidenceStatus: "canvas-source-span-complete",
        orthographyStatus: "typed-boundary-realization",
        ...
        plannedArrows: [
            {
                id: "lesson-58-canonical-owner-exhaustive-closure",
                type: "typed-grammar-source-span-test",
                aim: "Probar todos los miembros de los inventarios cerrados mediante sus dueños de cláusula nuclear nominal, cláusula nuclear verbal, construcción y suplementación, además de la paridad escalar/paradigma y la frontera hostil contra el tramo exacto de Lección 58 del Canvas.",
                andrewsRefs: ["Andrews Lesson 58.1-58.8", "ANDREWS_TRANSCRIPTION_CANVAS.md:25019-25462"],
                expectedFeedbackRefs: ["src/tests/fixtures/classical_lessons57_58_source_ledger.js", "src/tests/analysis.test.js"],
            },
        ],
        firedArrows: [
            {
                id: "lesson-58-canonical-owner-exhaustive-closure",
                result: "hit",
                correction: "La Lección 58 reutiliza las operaciones canónicas de cláusula nuclear nominal, cláusula nuclear verbal, construcción nominal y suplementación; los inventarios cerrados son ejecutables, mah conserva polaridad tipada y los problemas textuales no tienen interfaz productiva.",
                andrewsRefs: ["Andrews Lesson 58.1-58.8", "ANDREWS_TRANSCRIPTION_CANVAS.md:25019-25462"],
                feedbackRefs: ["src/tests/fixtures/classical_lessons57_58_source_ledger.js", "src/tests/analysis.test.js"],
            },
        ],
...
function getAndrewsTrajectoryEvidenceStatus(lesson) {
    if (lesson.status === "implemented") {
        return "direct-canvas-audited";
    }
    if (lesson.status === "partially-implemented") {
        return "direct-canvas-partial";
    }
...
function getAndrewsTrajectoryOrthographyStatus(lesson) {
    if (lesson.id === 2) {
        return "contextual-classical-realization-required";
    }
    ...
    return "contextual-classical-realization-plus-source-gate-required";
}
    ...
    return [
        {
            ...
            andrewsRefs: trajectory.canvasRefs,
...
function getAndrewsLessonSourceGatedRouteSpec(lessonId) {
    ...
    if (lessonId === 2) {
        return {
            routeFamily: "foundation-metadata-route",
            routeKind: "contextual-classical-realization-route",
            sourceUnit: "Andrews transcription with typed slot context",
            targetUnit: "Classical visible spelling frame",
            sourceFormulaType: "ANDREWS_TRANSCRIPTION",
            targetFormulaType: "CLASSICAL_VISIBLE_SPELLING",
            formulaTemplate: "ANDREWS_TRANSCRIPTION(SLOT/POSITION) -> CLASSICAL_VISIBLE_SPELLING_FRAME",
            operation: "contextual-andrews-transcription-realization",
    ...
    if (lessonId === 56) {
        return {
            ...
            routeKind: "two-tier-personal-name-nnc",
            sourceUnit: "issued typed clause or complete clause unit",
            targetUnit: "personal-name CNN or licensed sentence/reranking AST",
            sourceFormulaType: "CN|CN+CN",
            targetFormulaType: "CNN|SENTENCE_OPERATION",
            formulaTemplate: "TYPED_SOURCE_UNIT -> DOWNGRADED_PREDICATE -> #OUTER_SUBJECT(INNER_CLAUSE_UNIT)Ø-Ø#",
            operation: "downgrade-complete-statement-to-personal-name-predicate",
            requirementIds: ["issued-inner-clause", "issued-source-unit", "independent-outer-subject", "fixed-outer-zero-number"],
        };
    }
    if (lessonId === 57 || lessonId === 58) {
        return {
            routeFamily: "canonical-shared-owner",
            routeKind: lessonId === 57
                ? "vnc-nnc-supplementation-owner-composition"
                : "nnc-denominal-construction-supplementation-owner-composition",
            sourceUnit: "owner-issued typed Source or Result",
            targetUnit: "canonical owner Result",
            sourceFormulaType: "VNC|NNC|CLAUSE_RELATION",
            targetFormulaType: "VNC|NNC|CLAUSE_RELATION",
            formulaTemplate:
                "TYPED_SOURCE -> LICENSED_SHARED_OPERATION -> CANONICAL_OWNER_RESULT",
            operation: "canonical-owner-operation-routing",
            requirementIds: [
                "owner-issued-source-or-result",
                "licensed-shared-operation",
                "independent-formula-and-written-projections",
            ],
        };
    }
    return {
        routeFamily: "documentary-source-classification",
        routeKind: "documentary-source-note",
        sourceUnit: "documentary evidence",
        targetUnit: "test-only classification",
        sourceFormulaType: "DOCUMENTARY_SOURCE",
        targetFormulaType: "TEST_ONLY_CLASSIFICATION",
        formulaTemplate:
            `DOCUMENTARY_SOURCE -> ANDREWS_${lessonId}_TEST_CLASSIFICATION`,
        operation: "documentary-source-classification",
        requirementIds: [
            "documentary-source",
            "test-only-classification-kind",
        ],
    };
}

function expandAndrewsLessonRouteRefs(canvasRefs, fallbackLessonId) {
    const refs = [];
    (ANDREWS_SECTION_DIGEST_ROUTE_REFS_BY_LESSON[String(fallbackLessonId)] || []).forEach((ref) => {
        refs.push(ref);
    });
    (Array.isArray(canvasRefs) ? canvasRefs : []).forEach((ref) => {
...
function buildAndrewsRoutePuzzleStackTemplate(route = {}) {
    ...
    const buildAbsolutiveAllomorphFrame = (inputFormula = "", options = {}) => {
        ...
        return {
            kind: "classical-absolutive-allomorph-frame",
            ...
            ],
            {
                actions: [
                    buildAction(
                        ...
                        {
                            sourceEvidence: "typed-classical-source-frame",
                    ...
                    buildAction(
                        ...
                        exampleTargetFormula,
                        "surface",
                        "realize formula boundaries in Classical Nahuatl spelling",
                        exampleSurface,
                        "zero markers and parentheses do not surface as letters",
                        {
                            sourceEvidence: "typed-classical-realization-frame",
    ...
    if (route.routeKind === "intransitive-vnc" || route.routeKind === "intransitive-source-route") {
        return buildProfile("exact-intransitive-cnv-shell", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "CNV surface", "Classical Nahuatl spelling realizes the filled CNV shell when licensed"),
        ]);
    }
    ...
    if (
        ...
        return buildProfile("exact-transitive-cnv-shell", [
            ...
            buildStep("#2 formula", "num1", "subject number", "num1#", "subject number closes the CNV shell"),
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "CNV surface", "surface waits for object/person/tense fillers and Classical Nahuatl spelling"),
        ]);
    }
    ...
    if (route.routeKind === "two-tier-personal-name-nnc") {
        return buildProfile("exact-personal-name-nnc-route", [
            buildStep("#1 entrada", route.sourceFormulaType || "CN|CN+CN", "issued source unit", route.sourceUnit || "issued typed clause or complete clause unit", "the engine accepts only a typed, issued clause or complete clause unit"),
            buildStep("#2 formula", "DOWNGRADE", "predicate conversion", "WHOLE_SOURCE_UNIT -> (INNER_PREDICATE_UNIT)", "the complete source statement is downgraded as one predicate stem; stored examples cannot supply it"),
            buildStep("#2 formula", "INNER_SUBJECT+INNER_PREDICATE", "preserved inner structure", "(INNER_CLAUSE_UNIT)", "the inner subject and predicate remain inside the downgraded predicate unit"),
            buildStep("#2 formula", "pers1-pers2", "outer subject connector", "#OUTER_SUBJECT", "the independent outer subject connector stays outside the predicate parentheses"),
            buildStep("#2 formula", "Ø-Ø", "fixed outer number", "#OUTER_SUBJECT(INNER_CLAUSE_UNIT)Ø-Ø#", "the personal-name CNN has fixed zero outer number and no tense slot"),
            buildStep("#3 salida", route.targetFormulaType || "CNN|SENTENCE_OPERATION", "canonical personal-name output", route.targetUnit || "personal-name CNN or licensed sentence/reranking AST", "surface output is licensed only from the canonical typed personal-name operation"),
        ]);
    }
    ...
    if (/causative/.test(route.routeKind || "")) {
        return buildProfile("exact-causative-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "causative CNV surface", "finite output waits for object/person/tense fillers and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (/applicative/.test(route.routeKind || "")) {
        return buildProfile("exact-applicative-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "applicative CNV surface", "finite output waits for object/person/tense fillers and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (/frequentative/.test(route.routeKind || "")) {
        return buildProfile("exact-frequentative-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "frequentative CNV surface", "finite output waits for person/tense and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (/nonactive/.test(route.routeKind || "")) {
        return buildProfile("exact-nonactive-verbstem-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "nonactive CNV surface", "finite output waits for person/tense and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (/perfective|present|past/.test(route.routeKind || "")) {
        return buildProfile("exact-cnv-tense-source-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "CNV surface", "surface waits for person/number and Classical Nahuatl spelling bridge"),
        ]);
    }
    ...
    if (/patientive/.test(route.routeKind || "")) {
        return buildProfile("exact-patientive-nominalization", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "patientive CNN surface", "surface waits for state, number, possessor, or Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (route.routeKind === "nominalized-vnc") {
        return buildProfile("exact-nominalized-vnc-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "nominalized VNC CNN surface", "surface waits for state, possessor, number, and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (/purposive-directional/.test(route.routeKind || "")) {
        return buildProfile("exact-purposive-directional-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "purposive CNV surface", "finite output waits for person, tense, direction, and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (/verbal-embed-compound|embedded-source-compound|compound-source-route/.test(route.routeKind || "")) {
        return buildProfile("exact-verbal-embed-compound-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "compound surface", "surface waits for matrix/embed compatibility and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (route.routeFamily === "derivational-boundary") {
        ...
        return buildProfile("exact-derivational-boundary-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "derived surface", "surface waits for the target route and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (route.routeFamily === "relational-nnc") {
        return buildProfile("exact-relational-nnc-route", [
            ...
            buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "relational surface", "surface waits for possessor, state, connector, and Classical Nahuatl contextual Classical realization"),
        ]);
    }
    ...
    if (route.routeFamily === "foundation-metadata-route") {
        ...
        if (route.routeKind === "contextual-classical-realization-route") {
            return buildProfile("exact-contextual-classical-realization-route", [
                buildStep("#1 entrada", route.sourceFormulaType || "ANDREWS_TRANSCRIPTION", "Andrews transcription source", route.sourceUnit || "Andrews transcription with typed slot context", "the typed grammar source supplies Andrews transcription and its slot"),
                buildStep("#2 formula", "SLOT/POSITION", "realization context", "ANDREWS_TRANSCRIPTION(SLOT/POSITION)", "the transcription is interpreted with its grammar slot and boundary position"),
                buildStep("#2 formula", "contextual spelling", "Classical realization", route.formulaTemplate || "ANDREWS_TRANSCRIPTION(SLOT/POSITION) -> CLASSICAL_VISIBLE_SPELLING_FRAME", "one Classical realization rule spells the typed source without adding lexical evidence"),
                buildStep("#3 salida", "surface", "Classical visible spelling", route.targetUnit || "Classical visible spelling frame", "the resulting spelling belongs to the canonical generated surface"),
            ]);
        }
    ...
    if (route.routeFamily === "foundation-route") {
        ...
        if (route.routeKind === "pronominal-source-route" || route.routeKind === "pronominal-nnc") {
            return buildProfile("exact-pronominal-cnn-route", [
                ...
                buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "CNN pronominal route", "surface waits for state/reference and Classical Nahuatl contextual Classical realization"),
            ]);
        }
        ...
        if (route.routeKind === "tense-slot-source-route") {
            return buildProfile("exact-tense-slot-route", [
                ...
                buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "CNV tense formula route", "surface waits for person, number, and Classical Nahuatl contextual Classical realization"),
            ]);
        }
        ...
        if (route.routeKind === "nominal-state-source-route") {
            return buildProfile("exact-nominal-state-slot-route", [
                ...
                buildStep("#3 salida", "surface", "realization gate", route.targetUnit || "CNN state formula route", "surface waits for subject/reference and Classical Nahuatl state realization"),
            ]);
        }
    ...
    if (route.routeFamily === "canonical-shared-owner") {
        const profileKind = route.routeKind === "vnc-nnc-supplementation-owner-composition"
            ? "exact-contextual-time-valence-supplementation-composition"
            : route.routeKind === "nnc-denominal-construction-supplementation-owner-composition"
                ? "exact-instrumental-construction-supplementation-composition"
                : "exact-typed-owner-composition";
        return buildProfile(profileKind, [
            buildStep(
                "#1 entrada",
                route.sourceFormulaType || "VNC|NNC|CLAUSE_RELATION",
                "fuente tipada emitida por el dueño",
                route.sourceUnit || "owner-issued typed Source or Result",
                "la entrada aporta solamente constituyentes o un resultado emitido y autorizado por el dueño canónico correspondiente"
            ),
            buildStep(
                "#2 formula",
                "LICENSED_SHARED_OPERATION",
                "operación gramatical canónica",
                route.operation || "canonical-owner-operation-routing",
                "el dueño semántico valida y aplica la operación reutilizable sin consultar el currículo ni ejemplos almacenados"
            ),
            buildStep(
                "#3 salida",
                route.targetFormulaType || "VNC|NNC|CLAUSE_RELATION",
                "resultado del dueño canónico",
                route.targetUnit || "canonical owner Result",
                "las proyecciones de fórmula y escritura se emiten independientemente desde el mismo resultado tipado"
            ),
        ]);
    }

    if (route.routeFamily === "canonical-source-classification") {
        const diagnosticTargetProfiles = {
            ...
            CLASSICAL_VISIBLE_SPELLING: {
                profileKind: "exact-diagnostic-orthography-route",
                piece: "CLASSICAL_VISIBLE_SPELLING",
                label: "Classical visible spelling frame",
                note: "the diagnostic source records contextual realization of Andrews transcription",
            },
            PARTICLE_BOUNDARY: {
        ...
        return buildProfile("exact-source-classification-route", [
...
const ANDREWS_INTERNAL_FALLBACK_KEYWORD_ROUTE_SPECS = Object.freeze([
    ...
    ["spelling", "orthography-source", "ANDREWS_TRANSCRIPTION", "CLASSICAL_VISIBLE_SPELLING", "ANDREWS_TRANSCRIPTION(SLOT/POSITION) -> CLASSICAL_VISIBLE_SPELLING_FRAME"],
    ...
    ["isl", "orthographic-cluster-source", "ANDREWS_TRANSCRIPTION", "CLASSICAL_VISIBLE_SPELLING", "ORTHOGRAPHIC_CLUSTER_SOURCE -> CLASSICAL_VISIBLE_SPELLING_FRAME"],
...
function getAndrewsInternalSubsectionRouteSpec(parentSpec, entry) {
    ...
    if (entry.id === "46.3.1.b") {
        return withParent({
            ...
            structuralInfo: {
                ...
                relationalMatrix: "(-n)-tli-",
                connectorLayer: "-0-",
                implementationNote: "Structural route only until a Classical Nahuatl surface is licensed.",
            },
        });
    }
    ...
    for (const [keyword, routeToken, sourceFormulaType, targetFormulaType, formulaTemplate] of ANDREWS_INTERNAL_FALLBACK_KEYWORD_ROUTE_SPECS) {
        if (has(keyword)) {
            return withParent({
                routeFamily: "canonical-source-classification",
...
function buildAndrewsSubsectionSourceGatedRoutes(lesson, trajectory, spec) {
    return expandAndrewsLessonRouteRefs(trajectory.canvasRefs, lesson.id).map((andrewsRef) => {
        ...
        const internalRoutes = internalEntries.map((entry) => {
            ...
            return withAndrewsRoutePuzzleStackTemplate({
                ...
                generationAllowed: lesson.id === 53,
            });
        });
        return withAndrewsRoutePuzzleStackTemplate({
...
function buildAndrewsLessonSourceGatedRouteContract(lesson, trajectory) {
    ...
    return withAndrewsRoutePuzzleStackTemplate({
        ...
        routeFamily: spec.routeFamily,
        routeKind: spec.routeKind,
        andrewsRefs: Array.from(trajectory.canvasRefs),
        sourceUnit: spec.sourceUnit,
        targetUnit: spec.targetUnit,
        sourceFormulaType: spec.sourceFormulaType,
        targetFormulaType: spec.targetFormulaType,
...
function buildAndrewsLessonTrajectory(lesson) {
    ...
    const trajectory = {
        canvasRefs: override.canvasRefs || [`Andrews Lesson ${lesson.id}`],
...
const LESSON_REGISTRY_BASE = [
    ...
    },
    {
        ...
        notes: "El subconjunto supletivo Classical Nahuatl está implementado; los perfectivos irregulares de Andrews, verbos defectivos y desplazamientos tiempo-significado siguen incompletos",
    },
    {
        id: 12,
    ...
    },
    {
        ...
        exampleVerbs: [],
        notes: "Existen metadatos diagnósticos de análisis de compuestos y marcos de compuesto para Andrews 28.1-28.12, pero siguen parciales o pendientes de evidencia: generación de incrustación de pretérito con conectivo -t, inventarios limitados de matriz, formaciones especiales pasivas/impersonales, posesión acompañante, compuestos con matriz reflexiva, compuestos de objeto compartido, compuestos de incrustación futura, recursión y ejemplos Classical Nahuatl confirmados",
    },
    {
        id: 29,
        ...
        exampleVerbs: [],
        notes: "Existen metadatos diagnósticos de límite purposivo/direccional para Andrews 29.1-29.7, pero siguen parciales o pendientes de evidencia: generación purposiva saliente/entrante, comportamiento de morfema futuro silencioso, desambiguación de longitud vocálica y saltillo, comportamiento opcional o#, plural irregular n, incrustaciones pasivas/impersonales, incrustaciones con tronco compuesto, alternativas externas wal/on, lecturas de propósito cumplido y ejemplos Classical Nahuatl confirmados",
    },
    {
        id: 30,
    ...
    },
    {
        ...
        exampleVerbs: [],
        notes: "Existen metadatos diagnósticos de tronco nominal compuesto para Andrews 31.1-31.13, pero siguen parciales o pendientes de evidencia: análisis compuesto específico de cláusula nominal, segmentación enlazada/sin conectivo/integrada, orientación de poseedor, alomorfía de clase de incrustación, rellenadores únicos, comportamiento de matriz ka/yu, compuestos conjuntivos, compuestos recursivos, patrones de sexo/progenie/compañerismo, troncos de afinidad, troncos distributivos/varietales y ejemplos Classical Nahuatl confirmados",
    },
    {
        id: 32,
    ...
    },
    {
        ...
        exampleVerbs: [],
        notes: "Existen metadatos diagnósticos de numerales cardinales en cláusula nominal para Andrews 34.1-34.16, pero siguen parciales o pendientes de evidencia: generación de numerales cardinales, troncos básicos, conteos gruesos, compuestos de orden alto, numerales conjuntados, conjuntos clasificadores, reduplicación, aproximación, medidas y ejemplos Classical Nahuatl confirmados",
    },
    {
        id: 35,
    ...
    },
    {
        ...
        engineDependencies: ["core/nnc", "core/nnc/nominalization", "core/derivation"],
        exampleVerbs: [],
        notes: "Existen metadatos diagnósticos de cláusula verbal nominalizada para Andrews 36.1-36.12, y algunas salidas Classical Nahuatl agentivas habituales, patientivas, instrumentivas, agentivas de presente/futuro, de acción pasiva y de acción activa existen, pero siguen parciales o pendientes de evidencia: enrutamiento de reanálisis/nominalización plena, posesivos raros, híbridos de objeto activado, excepciones de fuente de estado, incrustaciones futuras lexicalizadas, alternancias de acción de uso restringido/general, sentidos lexicalizados y ejemplos Classical Nahuatl confirmados",
    },
    {
        id: 37,
    ...
    },
    {
        ...
        engineDependencies: ["core/nnc", "core/nnc/nominalization", "core/derivation"],
        exampleVerbs: [],
        notes: "Existen metadatos diagnósticos de patientivo impersonal para Andrews 38.1-38.2, y algunas continuaciones Classical Nahuatl generadas de patientivo impersonal, ne reflexivo, ta proyectivo, te-a-ta y patientivo compuesto existen, pero siguen parciales o pendientes de evidencia: enrutamiento completo de familias de fuente, selección raíz-más-ya, contraste humano/no humano, formas te anómalas, desambiguación de homónimos, comportamiento patientivo compuesto y ejemplos Classical Nahuatl confirmados",
    },
    {
        id: 39,
    ...
    },
    {
        ...
        exampleVerbs: [],
        notes: "Existen metadatos diagnósticos de modificación adjetival para Andrews 42.1-42.10, y el AST actual compone superficies Classical Nahuatl provistas para órdenes seleccionados de modificador/núcleo, pero siguen parciales o diagnósticos: sintaxis de varios núcleos, resolución de ambigüedad de suplementación, selección de matriz en núcleo compuesto, ambigüedad de modificador verbal transitivo, comportamiento de núcleo pronominal/cuantitativo/numeral, comportamiento de núcleo nominal de medida, recursión, estructuras de modificación incorporada, detección de analizador/búsqueda, ejemplos de cláusula con respaldo estático y fuente Andrews concreta y puente ortografico confirmado",
    },
    {
        id: 43,
        ...
        engineDependencies: ["core/clause", "core/clause/modification"],
        exampleVerbs: [],
        notes: "Existen metadatos diagnósticos de modificación adjetival para Andrews 43.1-43.9, y el AST actual puede marcar orden discontinuo en superficies Classical Nahuatl provistas, pero siguen parciales o diagnósticos: análisis de modificador no antepuesto, cooperación con el mismo núcleo, ambigüedad de núcleo interrogativo, núcleos oc ce, violaciones de referente compartido, modismos uno-de/ninguno-de, modificadores de vínculo masculino, modificadores de pareja nombrada, detección de analizador/búsqueda, ejemplos de cláusula con respaldo estático y fuente Andrews concreta y puente ortografico confirmado",
    },
    {
        id: 44,
    ...
    },
    {
        ...
        exampleVerbs: [],
        notes: "Lección 53 está implementada desde ANDREWS_TRANSCRIPTION_CANVAS.md únicamente: 23 rutas semánticas y 31 ejes de distinción comparten fuente tipada, operación, AST, fórmula y resultado seleccionado; 32 reclamos y 99 testigos se verifican fuera de producción y no autorizan salidas",
    },
    {
        id: 54,
    ...
    },
    {
        ...
        exampleVerbs: [],
        notes: "La Lección 56.1-56.5 está cerrada como una operación tipada de cláusula nominal nuclear de nombre personal: veinte familias de fuente y veinte ejes LCM comparten la GCD que degrada una unidad completa a predicado, preserva su estructura interna, mantiene el sujeto externo fuera de paréntesis y fija número Ø-Ø sin tiempo; ocho operaciones de oración y reranking conservan autoridad única, con pruebas exhaustivas y hostiles contra el tramo exacto del Canvas",
    },
    {
        id: 57,
        ...
        exampleVerbs: [],
        notes: "La Lección 57 reutiliza los dueños canónicos de cláusula nuclear verbal, cláusula nuclear nominal y suplementación: el tiempo contextual conserva el resultado verbal finito, la valencia es fuente léxica cerrada, las relaciones de cláusula se componen por suplementación y los troncos en l son fuentes nominales ordinarias; no existe ruta ni resultado genérico de análisis",
    },
    {
        id: 58,
        ...
        exampleVerbs: [],
        notes: "La Lección 58 reutiliza cláusula nuclear nominal ordinaria, cláusula nuclear verbal denominal, construcción nominal y suplementación: az y sus continuaciones son inventarios léxicos cerrados, mah y exclamación son composiciones compartidas, el nombre incorporado conserva sus restricciones, y los problemas textuales son evidencia de prueba sin interfaz productiva",
    },
];
