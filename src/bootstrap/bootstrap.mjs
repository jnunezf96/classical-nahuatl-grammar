import { installRuntimeBridge } from "./runtime_bridge.mjs?v=20260814-nnc-state-recovery-242";
...
} from "../runtime/create_runtime.mjs?v=20260814-nnc-state-recovery-242";
