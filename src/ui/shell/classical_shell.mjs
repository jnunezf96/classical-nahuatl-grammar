...
} from "../curriculum/lesson11_reader_guidance.mjs?v=20260813-lesson11-groups10-12-004";
import {
  LESSON12_READER_GUIDANCE_GROUPS,
  isLesson12ReaderGuidanceExact,
  renderLesson12ReaderGuidance,
} from "../curriculum/lesson12_reader_guidance.mjs?v=20260813-lesson12-complete-002";
import {
  LESSON13_READER_GUIDANCE_GROUPS,
  isLesson13ReaderGuidanceExact,
  renderLesson13ReaderGuidance,
} from "../curriculum/lesson13_reader_guidance.mjs?v=20260813-lesson13-complete-002";
import {
  LESSON14_READER_GUIDANCE_GROUPS,
  isLesson14ReaderGuidanceExact,
  renderLesson14ReaderGuidance,
} from "../curriculum/lesson14_reader_guidance.mjs?v=20260813-lesson14-complete-003";
import {
  LESSON15_READER_GUIDANCE_GROUPS,
...
${renderLesson12ReaderGuidance(escapeClassicalShellHtml)}
...
${renderClassicalResultOutputScopeOptions("vnc")}
    ...
    function ClassicalFooter() {
      return `      <footer>
            ...
            <p><a href="privacy.html">Privacy</a> · <a href=".well-known/security.txt">Security</a> · Grammar OS v1.2.2</p>
          </footer>
    `;
    }
...
${steps}
    ...
    api.LESSON12_READER_GUIDANCE_GROUPS = LESSON12_READER_GUIDANCE_GROUPS;
    api.isLesson12ReaderGuidanceExact = isLesson12ReaderGuidanceExact;
    api.LESSON13_READER_GUIDANCE_GROUPS = LESSON13_READER_GUIDANCE_GROUPS;
    api.isLesson13ReaderGuidanceExact = isLesson13ReaderGuidanceExact;
    api.LESSON14_READER_GUIDANCE_GROUPS = LESSON14_READER_GUIDANCE_GROUPS;
