...
export function createGenerationRuntimeSupportApi(targetObject = globalThis, installationContext = null) {
...
export function installGenerationRuntimeSupportGlobals(targetObject = globalThis, installationContext = null) {
    const api = createGenerationRuntimeSupportApi(targetObject, installationContext);
