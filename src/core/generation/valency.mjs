...
export function createGenerationValencyModule(targetObject = globalThis) {
    ...
    const VNC_VALENCE_NUMBER_CONNECTOR_SPECS = Object.freeze({
      ...
      preterit3sg: Object.freeze({
        ...
        classicalFormula: "c-0/qu-0/qui-0",
        compactDisplay: "c/qu~qui",
        surface: "c/qu~qui",
        evidenceSource: "Andrews 5.1-5.3"
      })
    });
    ...
    const VNC_VALENCE_DYADIC_SPECS = Object.freeze({
      nēch: Object.freeze({
        ...
        key: "nēch",
        andrewsStructural: "n-ēch",
        classicalFormula: "n-ēch",
        compactDisplay: "nēch",
        surfacePrefix: "nēch",
        trajectory: "projective",
        specificity: "specific",
        evidenceSource: "Andrews 6.4-6.5"
      }),
      tēch: Object.freeze({
        id: "1pl-specific-object",
        key: "tēch",
        andrewsStructural: "t-ēch",
        classicalFormula: "t-ēch",
        compactDisplay: "tēch",
        surfacePrefix: "tēch",
        trajectory: "projective",
        specificity: "specific",
      ...
      amēch: Object.freeze({
        ...
        key: "amēch",
        andrewsStructural: "am-ēch",
        classicalFormula: "am-ēch",
        compactDisplay: "amēch",
        surfacePrefix: "amēch",
        trajectory: "projective",
        specificity: "specific",
        evidenceSource: "Andrews 6.4-6.5"
      ...
      quim: Object.freeze({
        ...
        classicalFormula: "qu-im",
        compactDisplay: "quim/quin",
        surfacePrefix: "quim",
        trajectory: "projective",
        specificity: "specific",
        evidenceSource: "Andrews 6.4-6.5"
      ...
      mo: Object.freeze({
        ...
        trajectory: "reflexive-reciprocative",
        specificity: "specific",
        evidenceSource: "Andrews 6.6-6.7"
      })
    });
    ...
    function getVncValenceAndrewsLogicAuthorityPolicy() {
      return typeof targetObject.getAndrewsLogicAuthorityPolicy === "function" ? targetObject.getAndrewsLogicAuthorityPolicy() : {
        ...
        contextualClassicalRealizationRequired: true,
    ...
    function normalizeVncValenceWorkbenchRawStemForSourceFrame(value = "") {
      ...
      return String(stemSource || "").trim().replace(/^[-#\s]+/gu, "").replace(/[#()]/gu, "").replace(/^(?:ne|tē|tla|qui|quim|nēch|tēch|mitz|amēch|mo)[-\s]+/iu, "").trim();
    }
    function buildVncValenceWorkbenchSourceFrame({
      ...
      if (known) {
        ...
        const plusMatch = raw.match(/\+(ne|tē|tla|qui|quim|nēch|tēch|mitz|amēch|mo)(?:[-+()#\s]|$)/u);
        const prefixMatch = raw.match(/^(ne|tē|tla|qui|quim|nēch|tēch|mitz|amēch|mo)[-\s]+/u);
        const marker = plusMatch?.[1] || prefixMatch?.[1] || "";
    ...
    function getVncValenceMonadicSpec(key = "tla") {
      const normalized = String(key || "tla").trim().toLowerCase();
      return VNC_VALENCE_MONADIC_SPECS[normalized] || VNC_VALENCE_MONADIC_SPECS.tla;
    }
    function getVncValenceDyadicSpec(key = "qui", {
      stem = "",
      subjectPrefix = "",
      subjectSuffix = ""
    } = {}) {
      const normalized = String(key || "qui").trim().toLowerCase();
      const directFrame = typeof targetObject.getDirectClassicalObjectDyadFrame === "function" ? targetObject.getDirectClassicalObjectDyadFrame(normalized, {
        stem,
        pers1: subjectPrefix,
        pers2: subjectSuffix
      }) : null;
      const base = VNC_VALENCE_DYADIC_SPECS[normalized] || VNC_VALENCE_DYADIC_SPECS.qui;
      if (!directFrame) {
        return base;
      }
      return {
        ...base,
        classicalFormula: directFrame.visibleFormulaPrefix || base.classicalFormula,
        compactDisplay: directFrame.sourcePrefix || base.compactDisplay,
        surfacePrefix: directFrame.realizedSurfacePrefix || directFrame.surfaceScopedPrefix || directFrame.sourcePrefix || base.surfacePrefix,
        trajectory: directFrame.trajectory || base.trajectory,
        specificity: directFrame.specificity || base.specificity,
        directClassicalDyadFrame: directFrame
      };
    }
    ...
    function buildVncValenceTenseSlot(tense = "zero") {
      ...
      return {
        ...
        classicalDisplay: spec.classicalFormula,
        classicalRealization: spec.classicalFormula,
        compactDisplay: spec.compactDisplay,
        display: spec.andrewsStructural,
        value: spec.andrewsStructural,
        morph: spec.classicalFormula,
    ...
    function buildVncValenceNumberSlot(connector = "zero") {
      ...
      const primaryClassicalFormula = String(spec.classicalFormula || "Ø-Ø").split(/\s*~\s*/)[0] || "Ø-Ø";
      const [classicalNum1 = "Ø", classicalNum2 = "Ø"] = primaryClassicalFormula.split("-");
      return {
        ...
        connector: spec.classicalFormula,
        ...
        classicalDyad: spec.classicalFormula,
    ...
    function buildVncValenceObjectSlot({
      ...
      const subjectSuffix = String(subject?.subjectSuffix || subject?.suffix || "");
      ...
      return {
        ...
        structuralDisplay: spec.andrewsStructural || "",
        andrewsStructural: spec.andrewsStructural || "",
        classicalDisplay: spec.classicalFormula || spec.compactDisplay || "",
        classicalRealization: spec.classicalFormula || spec.compactDisplay || "",
        ...
        evidenceSource: spec.evidenceSource || "",
        directClassicalDyadFrame: spec.directClassicalDyadFrame || null,
    ...
    function buildVncValenceFormulaEchoFromSlots(formulaSlots = null, {
      ...
      const displayValence = mode === "compact" ? valenceSlot.compactDisplay || valenceSlot.surfacePrefix || valenceSlot.classicalDisplay || valenceSlot.structuralDisplay || "" : mode === "classical" ? valenceSlot.classicalDisplay || valenceSlot.classicalRealization || valenceSlot.compactDisplay || valenceSlot.structuralDisplay || "" : valenceSlot.structuralDisplay || valenceSlot.andrewsStructural || valenceSlot.display || "";
      const displayTense = mode === "structural" ? tenseSlot.structuralDisplay || tenseSlot.andrewsStructural || tenseSlot.display || "0" : tenseSlot.classicalDisplay || tenseSlot.classicalRealization || tenseSlot.compactDisplay || "Ø";
      const displayNumber = expanded ? mode === "structural" ? numberConnector.structuralDisplay || numberConnector.displayDyad || "0-0" : numberConnector.classicalDisplay || numberConnector.classicalDyad || numberConnector.displayDyad || "Ø-Ø" : numberConnector.compactDisplay || numberConnector.surface || "Ø";
      const echoSlots = {
        ...formulaSlots,
    ...
    function buildVncValenceFormulaWorkbenchSlotRecords(schema = null, formulaSlots = {}) {
      ...
      return slots.map(slot => {
        ...
        const classicalValue = (() => {
          if (slot.key === "valence") {
            return String(sourceSlot.classicalDisplay || sourceSlot.classicalRealization || sourceSlot.compactDisplay || structuralValue);
          }
          if (slot.key === "tensePosition") {
            return String(sourceSlot.classicalDisplay || sourceSlot.classicalRealization || sourceSlot.compactDisplay || "Ø");
          }
          if (slot.key === "num1Num2") {
            return String(sourceSlot.classicalDisplay || sourceSlot.classicalDyad || structuralValue || "Ø-Ø");
          }
          return structuralValue;
        })();
        const compactValue = (() => {
          if (slot.key === "valence" || slot.key === "tensePosition" || slot.key === "num1Num2") {
            return String(sourceSlot.compactDisplay || sourceSlot.surfacePrefix || sourceSlot.surface || classicalValue || structuralValue);
          }
          return structuralValue;
        })();
    ...
    function buildVncValenceExample({
      ...
      const classicalFormulaEcho = buildVncValenceFormulaEchoFromSlots(formulaSlots, {
        mode: "classical",
        expanded: true
      });
    ...
    function getVncValenceScopedSurfaceForSlots(formulaSlots = null) {
      ...
      if (kind === "monadic" && key === "tla" && stem === "chīhua") {
        return "tlachīhua";
      }
      if (kind === "dyadic" && key === "qui" && stem === "chīhua") {
        return "quichīhua";
      }
      return "";
    }
    ...
    function buildVncValenceAndrewsLogicTargetSegmentFrames(formulaSlots = null) {
      ...
      const valencePrefix = kind === "intransitive" ? "" : normalizeVncValenceFormulaSurfacePart(valenceSlot.surfacePrefix || valenceSlot.classicalRealization || valenceSlot.classicalDisplay);
    ...
    function getVncValenceScopedNumberConnector({
      ...
      if (normalizedKind === "intransitive" && normalizedStem === "nemi") {
        return "preterit3sg";
      }
      return "zero";
    }
    function buildVncValenceFormulaWorkbenchSlice({
      ...
      return {
        ...
        sourceMaterial: {
          ...
          placeholder: "nemi / tla-chīhua / qui-chīhua",
        ...
        evidenceRefs: [...(Array.isArray(schema?.evidenceRefs) ? schema.evidenceRefs : []), "Andrews formula inventory: VNC valence/object slots"].filter(Boolean),
        realizationBoundary: {
          structuralFormulaEcho,
          classicalFormulaEcho,
          compactFormulaEcho,
          ...
          classicalAuthority: "Andrews transcription is realized contextually by the Classical engine; examples never gate grammar logic",
        ...
        diagnostics: [...(Array.isArray(sourceRequirementCheck.diagnostics) ? sourceRequirementCheck.diagnostics : []), ...slotBlockDiagnostics, ...(blockedReason ? [{
          ...
          severity: "note",
          message: "Andrews object spellings such as tla and c/qu/qui are structural rule evidence realized contextually by the Classical engine."
        }]
      };
    }
    function buildVncShellFormulaWorkbenchSlice({
      ...
      return {
        ...
        realizationBoundary: {
          ...
          classicalAuthority: "La transcripción de Andrews se realiza contextualmente en la CNV; tns no existe en fórmulas CNN."
        },
        generation: {
          ...(slice.generation || {}),
          routeFamily: "vnc-shell",
          outputPolicy: "La ranura tns pertenece solo a CNV; Andrews decide la lógica de ranuras y la realización contextual produce la salida."
        },
    ...
    const LESSON21_PASSIVE_CANVAS_REFS = Object.freeze(["Andrews Lesson 21.1", "Andrews Lesson 21.2", "Andrews Lesson 21.3", "Andrews Lesson 21.4"]);
    ...
    const LESSON21_PASSIVE_GENERATION_CASES = Object.freeze([Object.freeze({
      ...
      currentEngineStatus: "partial-classical-reflexive-slot-exists-but-passive-ne-witness-needs-audited-routing"
    }), Object.freeze({
    ...
    function getPassiveVoiceSubsectionInventory() {
    ...
    const LESSON22_IMPERSONAL_CANVAS_REFS = Object.freeze(["Andrews Lesson 22.1", "Andrews Lesson 22.2", "Andrews Lesson 22.3", "Andrews Lesson 22.4", "Andrews Lesson 22.5", "Andrews Lesson 22.6"]);
    ...
    const LESSON22_IMPERSONAL_GENERATION_FRAME = Object.freeze({
      ...
      nonspecificProjectiveObjectsPreserved: Object.freeze(["tē", "tla"]),
    ...
    const LESSON22_TA_IMPERSONAL_FRAME = Object.freeze({
      kind: "lesson-22-tla-impersonal-frame",
      sourceSection: "Andrews 22.6",
      derivationalPrefix: "tla",
      ...
      currentEngineStatus: "The typed impersonal-prefix slot exists, but the Lesson 22.6 derivational inventory and generation are not data-complete."
    });
    const LESSON22_IMPERSONAL_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      ...
      directiveEs: "La CNV impersonal usa la misma fórmula que la fuente activa, conserva objetos inespecíficos tē/tla y cambia el reflexivo fuente al testigo ne.",
      ...
      id: "lesson22-tla-impersonal",
      andrewsSection: "22.6",
      category: "tla-impersonal-derivation",
      directiveEs: "El prefijo impersonalizador tla es derivacional dentro del tronco y no el pronombre objeto inespecífico.",
      engineSurface: "typed impersonal-prefix metadata; no data-complete tla-impersonal derivation inventory",
      implementationState: "partial",
      redirectAction: "source-gated"
    })]);
    function getImpersonalVoiceSubsectionInventory() {
      return LESSON22_IMPERSONAL_SUBSECTION_INVENTORY.map(entry => ({
        ...entry,
        canvasRef: `Andrews Lesson ${entry.andrewsSection}`,
        evidenceStatus: "direct-canvas-partial",
        realizationStatus: "classical-contextual-realization-required",
    ...
    function isGenerationValencyObjectOrFusionPrefix(prefix = "") {
      ...
      return targetObject.SPECIFIC_VALENCE_PREFIX_SET.has(normalized) || targetObject.OBJECT_MARKERS.has(normalized) || targetObject.FUSION_PREFIXES.has(normalized) || ["c", "qu", "qui", "quim", "quin", "nēch", "tēch", "mitz", "amēch", "tē", "tla", "mo", "n", "t", "m"].includes(normalized);
    }
    ...
    function applyObj1Allomorphy(input = {}) {
      ...
      const isReflexiveObject = !isPassiveImpersonalMode && (obj1 === "mo" || targetObject.isPers1Obj1Reflexivo(pers1, pers2, obj1));
      const reflexiveDyadFrame = isReflexiveObject && typeof targetObject.getDirectClassicalObjectDyadFrame === "function" ? targetObject.getDirectClassicalObjectDyadFrame("mo", {
        stem: analysisVerb || verb,
        pers1,
        pers2
      }) : null;
      const allomorphyObjectPrefix = reflexiveDyadFrame?.realizedSurfacePrefix || (isReflexiveObject ? "mo" : obj1);
    ...
    Object.defineProperty(api, "LESSON21_PASSIVE_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON21_PASSIVE_CANVAS_REFS; },
    });
    ...
    api.getPassiveVoiceSubsectionInventory = getPassiveVoiceSubsectionInventory;
    Object.defineProperty(api, "LESSON22_IMPERSONAL_VALIDATION_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON22_IMPERSONAL_VALIDATION_REFS; },
    });
    Object.defineProperty(api, "LESSON22_IMPERSONAL_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON22_IMPERSONAL_CANVAS_REFS; },
    });
    ...
    api.getImpersonalVoiceSubsectionInventory = getImpersonalVoiceSubsectionInventory;
