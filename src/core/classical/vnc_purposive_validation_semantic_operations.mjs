...
function compact(runtime, frame) {
  ...
  return {
    ...
    facts: {
      ...
      futureEmbedSelectedShape: facts.futureEmbedSelectedShape || "",
      futureEmbedSelectedShapeReason: facts.futureEmbedSelectedShapeReason || "",
      futureEmbedUnderlyingStem: facts.futureEmbedUnderlyingStem || "",
      futureEmbedSilentClassCarrier: facts.futureEmbedSilentClassCarrier || "",
      futureEmbedUsesSharedLesson7ShapeOwner:
        facts.futureEmbedUsesSharedLesson7ShapeOwner === true,
