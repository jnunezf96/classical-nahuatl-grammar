const spec = {
  ...
  "coordinates": {
    ...
    "claim-p2712::p2712-hua-hua-l-ca-for-a-boiling-liquid-to": {
      "assertionId": "classical-uncertain-ca-frequentative:p2712-hua-hua-l-ca-for-a-boiling-liquid-to",
      "canonicalPath": "cases.uncertainCa.authorizationStatus"
    },
