...
export function createOutputSurfaceApi(targetObject = globalThis, installationContext = null) {
    ...
    function appendSurfaceChainLesson2Frame(chain = null, role = "", frameInput = {}, beforeValue = "", afterValue = "") {
      ...
      const frame = frameInput && typeof frameInput === "object"
        ? {
          ...frameInput,
          authority: "Classical Andrews transcription",
    ...
    function realizeSurfaceChain(chain = null) {
      return cloneSurfaceChainState(chain);
    }
    ...
    function buildOutputPrefixedChain(input = {}) {
      ...
      return `${pers1}${poseedor}${obj1}${tronco}`;
    }
    function buildOutputWordSegments(input = {}) {
      ...
      [
        ...
        if (value) {
          segments.push({ role, slot: role, value: String(value) });
        }
      });
      if (pers2) {
        segments.push({
    ...
    function getOutputSurfaceResultFrame(record = null, options = {}) {
      ...
      return frame
        ...
        && targetObject.isIssuedGrammarFrame(frame)
        && frame.resultFrame
        && typeof frame.resultFrame === "object"
        ? frame.resultFrame
        : null;
    }
    function getOutputSurfaceSurfaceForms(record = null, fallbackSurface = "", options = {}) {
      ...
      return splitOutputSurfaceContractSurfaceText(fallbackSurface)
    ...
    function attachOutputSurfaceGrammarContract(record = null, options = {}) {
      ...
      const fallbackSurface = joinOutputWordSegments(segments);
      ...
      const optionFrame = options?.grammarFrame && typeof options.grammarFrame === "object" ? options.grammarFrame : options?.frames && typeof options.frames === "object" ? options.frames : null;
      const recordFrame = record?.grammarFrame && typeof record.grammarFrame === "object" ? record.grammarFrame : record?.frames && typeof record.frames === "object" ? record.frames : null;
      const inboundFrameCandidate = optionFrame || recordFrame || null;
      const inboundFrame = inboundFrameCandidate
        && typeof targetObject.isIssuedGrammarFrame === "function"
        && targetObject.isIssuedGrammarFrame(inboundFrameCandidate)
        ? inboundFrameCandidate
        : null;
...
export function installOutputSurfaceGlobals(targetObject = globalThis, installationContext = null) {
    const api = createOutputSurfaceApi(targetObject, installationContext);
