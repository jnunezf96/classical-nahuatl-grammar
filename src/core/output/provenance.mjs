...
export function createOutputProvenanceGlobals(targetObject = globalThis, installationContext = null) {
...
export function installOutputProvenanceGlobals(targetObject = globalThis, installationContext = null) {
    const api = createOutputProvenanceGlobals(targetObject, installationContext);
