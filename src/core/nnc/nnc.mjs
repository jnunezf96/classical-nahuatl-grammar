...
export function createNncApi(targetObject = globalThis, installationContext = null) {
    ...
    const ORDINARY_NNC_POSSESSIVE_PREFIX_INVENTORY = Object.freeze([
      Object.freeze({ id: "none", value: "", number: "none" }),
      Object.freeze({ id: "1s", personSubKey: "1sg", value: "no", number: "singular" }),
      Object.freeze({ id: "2s", personSubKey: "2sg", value: "mo", number: "singular" }),
      Object.freeze({ id: "3s", personSubKey: "3sg", value: "ī", number: "singular" }),
      Object.freeze({ id: "1p", personSubKey: "1pl", value: "to", number: "plural" }),
      Object.freeze({ id: "2p", personSubKey: "2pl", value: "amo", number: "plural" }),
      Object.freeze({ id: "3p", personSubKey: "3pl", value: "in", number: "plural" })
    ]);
    ...
    const ORDINARY_NNC_DIAGNOSTIC_IDS = Object.freeze({
      ...
      authorityCarrierRejected: "ordinary-nnc-authority-carrier-rejected",
    ...
    const ORDINARY_NNC_REQUEST_AUTHORITY_CARRIER_KEYS = Object.freeze([
      "formulaSlots",
      "clauseFrame",
      "nuclearClauseFrame",
      "routeContract",
    ...
    const issuedOrdinaryNncOrganicPossessionSourceFrames = new WeakSet();
    const issuedOrdinaryNncOrganicPossessionOperationFrames = new WeakSet();
    function getOrdinaryNncOwnDataPropertyValue(record = null, key = "", fallback = null) {
    ...
    function getOrdinaryNncRequestAuthorityCarrierKeys(request = null) {
      ...
      try {
        ...
        while (cursor && typeof cursor === "object" && !seen.has(cursor)) {
          seen.add(cursor);
          ORDINARY_NNC_REQUEST_AUTHORITY_CARRIER_KEYS.forEach(key => {
            ...
            if (!Object.prototype.hasOwnProperty.call(descriptor, "value") || descriptor.value !== null && descriptor.value !== undefined) {
              found.push(key);
            }
          });
        ...
        return ["uninspectable-request"];
      }
      return found;
    }
    function normalizeOrdinaryNncNounClass(value = "") {
      const normalized = normalizeOrdinaryNncText(value).replace(/[\s_-]/gu, "");
      return ORDINARY_NNC_NOUN_CLASS_CONTRACT.aliases[normalized] || "";
    }
    function buildOrdinaryNncNounClassSelectionFrame(value = "", {
      ...
      const normalizedValue = normalizeOrdinaryNncNounClass(requestedValue);
      ...
      return Object.freeze({
        ...
        version: 1,
        language: ORDINARY_NNC_NOUN_CLASS_CONTRACT.language,
        requestedValue,
        normalizedValue,
        recognized,
        inputProvided,
    ...
    function buildOrdinaryNncNounClassControlInventoryValidationFrame({
      ...
      const expectedValues = Array.from(ORDINARY_NNC_NOUN_CLASS_CONTRACT.values);
      const normalizeList = values => Array.isArray(values) ? values.map(value => String(value || "").trim()).filter(Boolean) : [];
      const actualControlValues = normalizeList(controlValues);
      const actualLedgerValues = normalizeList(ledgerValues);
      const same = (left, right) => left.length === right.length && left.every((value, index) => value === right[index]);
      const controlsMatch = same(actualControlValues, expectedValues);
      const ledgerMatches = same(actualLedgerValues, expectedValues);
      const authorizationStatus = controlsMatch && ledgerMatches ? "authorized" : "blocked";
      return Object.freeze({
        ...
        controlValues: Object.freeze(actualControlValues),
        ledgerValues: Object.freeze(actualLedgerValues),
        controlsMatch,
        ledgerMatches,
    ...
    const NNC_LESSON12_CANVAS_REFS = Object.freeze(["Andrews Lesson 12.1", "Andrews Lesson 12.2", "Andrews Lesson 12.3", "Andrews Lesson 12.4", "Andrews Lesson 12.5", "Andrews Lesson 12.6", "Andrews Lesson 12.7"]);
    ...
    const NNC_LESSON12_SUBJECT_POSITION_FRAME = Object.freeze({
      ...
      num1Num2Rule: Object.freeze({
        ...
        contextualClassicalRealization: Object.freeze([Object.freeze({
          classicalDyad: "m-eh",
          realizedDyad: "m-eh",
          num1: "m",
          classicalNum2: "eh",
          realizedNum2: "eh",
          orthographyRule: "Andrews transcription is retained in Classical output."
        })]),
      ...
      classicalRealizationStatus: "Andrews filler morphs and contextual Classical spelling share one typed realization path."
    });
    ...
    const NNC_LESSON12_REMAINING_GAPS = Object.freeze(["The full Andrews 12.3-12.4 absolutive subject-pronoun filler inventory is not generated as a complete paradigm.", "Current ordinary NNC output realizes typed Andrews num1-num2 fillers contextually; stored or displayed surface strings cannot authorize them.", "Discourse time reference, definiteness/article choice, metaphorical animacy overrides, and state-restriction exceptions remain diagnostic or deferred."]);
    const NNC_LESSON13_VALIDATION_REFS = Object.freeze(["src/tests/nnc.test.js", "src/tests/registry.test.js", "docs/GRAMMAR_SPEC.md"]);
    const NNC_LESSON13_CANVAS_REFS = Object.freeze(["Andrews Lesson 13.1", "Andrews Lesson 13.2", "Andrews Lesson 13.3", "Andrews Lesson 13.4", "Andrews Lesson 13.5", "Andrews Lesson 13.6"]);
    ...
    const NNC_LESSON13_SUBJECT_PRONOUN_INVENTORY_FRAME = Object.freeze({
      ...
      classicalRealizationStatus: "subject connectors are realized contextually from the typed Andrews dyads",
      generationAllowed: false
    });
    const NNC_LESSON13_MONADIC_STATE_FRAME = Object.freeze({
      ...
      fillers: Object.freeze([Object.freeze({
        ...
        classicalStatus: "requires a typed Andrews source gate before generation"
      }), Object.freeze({
        id: "human-nonspecific-possessor",
        andrewsMorph: "te",
        meaning: "someone's / anyone's / everyone's",
        frequency: "frequent",
        classicalCandidate: "te",
        classicalStatus: "requires a typed Andrews source gate before generation"
      }), Object.freeze({
    ...
    const NNC_LESSON13_SPECIFIC_POSSESSOR_FRAME = Object.freeze({
      ...
      possessors: Object.freeze([Object.freeze({
        ...
        andrews: "n-o ~ n-□",
        meaning: "my",
        currentClassicalPrefix: "no"
      }), Object.freeze({
        id: "1pl",
        andrews: "t-o ~ t-□",
        meaning: "our",
        currentClassicalPrefix: "to"
      }), Object.freeze({
        id: "2sg",
        andrews: "m-o ~ m-□",
        meaning: "your (sg)",
        currentClassicalPrefix: "mo"
      }), Object.freeze({
        id: "2pl",
        andrews: "am-o ~ am-□",
        meaning: "your (pl)",
        currentClassicalPrefix: "amo"
      }), Object.freeze({
        id: "3sg-common",
        andrews: "i-0",
        meaning: "his/her/its; its/their",
        currentClassicalPrefix: "ī"
      }), Object.freeze({
        id: "3pl",
        andrews: "i-m ~ i-n...",
        meaning: "their",
        currentClassicalPrefix: "in"
      })]),
      ...
      classicalRealizationStatus: "specific possessors are realized by the typed Andrews state-slot analysis",
      generationAllowed: false
    });
    const NNC_LESSON13_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      ...
      directiveEs: "Los poseedores especificos son pronombres posesivos; sus realizaciones Classical se toman de evidencia del repo, no de importacion grafica clasica.",
      engineSurface: "current possessor-prefix metadata",
      redirectAction: "source-gated",
      evidenceStatus: "direct-canvas-partial",
      implementationState: "partial"
    })]);
    const NNC_LESSON13_REMAINING_GAPS = Object.freeze(["The full Andrews possessive-state subject connector inventory is not generated as a complete paradigm.", "Monadic possessive-state NNCs with ne, tē, and nonhuman tla require a typed Andrews source stem before generation.", "Specific possessor prefixes realize Andrews st1/st2 logic directly; full contextual allomorphy and traditional-spelling caveats remain diagnostic metadata.", "Lesson 14 stem selection is required before possessive-state NNC generation can claim full Andrews coverage."]);
    const NNC_LESSON14_VALIDATION_REFS = Object.freeze(["src/tests/nnc.test.js", "src/tests/registry.test.js", "docs/GRAMMAR_SPEC.md"]);
    const NNC_LESSON14_CANVAS_REFS = Object.freeze(["Andrews Lesson 14.1", "Andrews Lesson 14.2", "Andrews Lesson 14.3", "Andrews Lesson 14.4", "Andrews Lesson 14.5", "Andrews Lesson 14.6", "Andrews Lesson 14.7", "Andrews Lesson 14.8"]);
    ...
    const NNC_LESSON14_CONSTITUENT_ANALYSIS_FRAME = Object.freeze({
      ...
      diagnosticRule: "keep alternative analyses open unless vocabulary, filler morphs, sound changes, and typed Andrews source logic settle the parse",
      generationAllowed: false
    });
    const NNC_LESSON14_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      ...
      directiveEs: "Las clases se nombran por num1 absolutivo singular/comun; en Classical actual son t, ti, in y zero, con membresia lexica no predecible.",
    ...
    const NNC_LESSON14_REMAINING_GAPS = Object.freeze(["Current ordinary NNC class handling enforces Classical tl/tli/in/zero shape compatibility, but full Andrews lexical class membership and class alternatives are not data-complete.", "Restricted-use versus general-use stem selection is not yet a complete engine contract for possessive NNCs and compound embed positions.", "Affinity and distributive/varietal nounstem derivation, plural-subject alternatives, and class/subclass num1 choices remain diagnostic or source-gated.", "Constituent-analysis ambiguities around uh, ti, tli, o, m, and traditional spelling remain diagnostic metadata until vocabulary and typed Andrews source logic settle them."]);
    const NNC_LESSON15_VALIDATION_REFS = Object.freeze(["src/tests/nnc.test.js", "src/tests/registry.test.js", "docs/GRAMMAR_SPEC.md"]);
    const NNC_LESSON15_CANVAS_REFS = Object.freeze(["Andrews Lesson 15.1", "Andrews Lesson 15.2", "Andrews Lesson 15.3"]);
    const NNC_LESSON15_POSSESSIVE_PECULIARITIES_FRAME = Object.freeze({
      ...
      possessivePluralAssimilation: Object.freeze({
        connector: "hu-ān",
        affectedStemFinals: Object.freeze(["voiceless uh", "n"]),
    ...
    const NNC_LESSON15_NATURALLY_POSSESSED_FRAME = Object.freeze({
      ...
      currentEngineBoundary: "current ordinary possessive fixtures and organic -yo opt-in do not prove complete Lesson 15 natural-possession classes",
      generationAllowed: false
    });
    ...
    const NNC_LESSON15_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      ...
      directiveEs: "Registrar asimilacion con hu-ān, suplencias posesivas, troncos secundarios, analogias con tla, reduplicacion de poseedor y poseedor nuclear sin generar paradigmas no confirmados.",
    ...
    const NNC_LESSON15_REMAINING_GAPS = Object.freeze(["Possessive plural assimilation, suppletive possessive stems, tē/tla secondary stems, possessor reduplication, and tli-subclass reclassification remain diagnostic until typed Andrews source models license concrete forms.", "Natural-possession state cases require lexical metadata for required, optional, unavailable, possessive-only, absolutive-unavailable, and irregular nouns.", "Current fixture-backed possessive forms and organic -yo generation do not prove complete Lesson 15 natural-possession coverage.", "NNC sentence-structure behavior remains sentence-layer metadata; sentence generation and particle placement are not licensed by ordinary NNC output alone."]);
    const NNC_LESSON16_VALIDATION_REFS = Object.freeze(["src/tests/nnc.test.js", "src/tests/registry.test.js", "docs/GRAMMAR_SPEC.md"]);
    const NNC_LESSON16_CANVAS_REFS = Object.freeze(["Andrews Lesson 16.1", "Andrews Lesson 16.2", "Andrews Lesson 16.3", "Andrews Lesson 16.4", "Andrews Lesson 16.5", "Andrews Lesson 16.6", "Andrews Lesson 16.7", "Andrews Lesson 16.8", "Andrews Lesson 16.9"]);
    ...
    const NNC_LESSON16_REMAINING_GAPS = Object.freeze(["A complete typed Andrews pronominal-NNC route contract is still needed before personal, interrogative, demonstrative, indefinite, or quantitive paradigms can generate.", "The current ordinary NNC formula slot model is not yet extended to a safe pronominal NNC route.", "Fused spellings such as tlein/aquin and demonstrative inin/inon remain diagnostic text-analysis metadata, not generated Classical fixtures.", "Quantitive matrix allomorphy, derivational plural n, adjectival-function use, and supplementation behavior remain diagnostic or deferred to later lessons."]);
    ...
    function normalizeOrdinaryNncPluralType(value = "") {
      ...
      if (normalized === "meh" || normalized === "count" || normalized === "ordinary") {
    ...
    function getOrdinaryNncPossessiveEntries() {
      return typeof targetObject.POSSESSIVE_PREFIXES !== "undefined" && Array.isArray(targetObject.POSSESSIVE_PREFIXES) && targetObject.POSSESSIVE_PREFIXES.length ? targetObject.POSSESSIVE_PREFIXES : ORDINARY_NNC_POSSESSIVE_PREFIX_INVENTORY;
    }
    ...
    function getNncPronominalRemainingGaps() {
    ...
    function isOrdinaryNncVowelFinalStem(stem = "") {
      return /[aeiouāēīō]$/iu.test(normalizeOrdinaryNncText(stem));
    }
    ...
    function getOrdinaryNncClassStemCompatibility(nounClass = "", stem = "") {
      ...
      const requiredStemShape = normalizedClass === "tl" ? "vowel-final" : "consonant-final";
      const compatible = normalizedClass === "tl" ? vowelFinal : !vowelFinal;
      return {
        compatible,
        nounClass: normalizedClass,
        stem: normalizedStem,
    ...
    function buildOrdinaryNncOrganicPossessionSourceFrame({
      ...
      const normalizedSourceStem = normalizeOrdinaryNncText(sourceStem).replace(/[()#]/g, "");
      if (!normalizedSourceStem || normalizeOrdinaryNncPossessionKind(possessionKind) !== ORDINARY_NNC_POSSESSION_KIND.organic) {
        return null;
      }
      ...
      const sourceFrame = Object.freeze({
        ...
        operation: "append-organic-possession-yo",
        sourceSignature,
      ...
      issuedOrdinaryNncOrganicPossessionSourceFrames.add(sourceFrame);
      return sourceFrame;
    }
    function buildOrdinaryNncOrganicPossessionOperationFrame(sourceFrame = null) {
      if (!sourceFrame || !issuedOrdinaryNncOrganicPossessionSourceFrames.has(sourceFrame) || sourceFrame.kind !== "ordinary-nnc-organic-possession-source-frame") {
        return null;
      }
      ...
      const matrixSurface = sourceStem.endsWith("yo") ? "" : "yo";
      ...
      const operationFrame = Object.freeze({
        ...
        operationId: "ordinary-nnc-organic-possession-yo-realization",
        family: "ordinary-nnc",
        routeFamily: "ordinary-nnc",
        routeStage: "organic-possession",
        ...
        targetFrame,
        operationApplied: "append-organic-possession-yo-from-source-frame",
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false
      });
      issuedOrdinaryNncOrganicPossessionOperationFrames.add(operationFrame);
    ...
    function getOrdinaryNncOrganicPossessionFrameMismatch({
      ...
      if (!operationFrame || !issuedOrdinaryNncOrganicPossessionOperationFrames.has(operationFrame) || operationFrame.kind !== "andrews-typed-operation-frame" || operationFrame.operationId !== "ordinary-nnc-organic-possession-yo-realization" || operationFrame.routeFamily !== "ordinary-nnc" || operationFrame.operationApplied !== "append-organic-possession-yo-from-source-frame" || operationFrame.consumesRenderedInput !== false || operationFrame.displayStringsAuthorizeGrammar !== false) {
      ...
      const expectedPredicateStem = `${sourceFrame.sourceStem || ""}${String(sourceFrame.sourceStem || "").endsWith("yo") ? "" : "yo"}`;
    ...
    function isOrdinaryNncPluralPossessor(possessor = null) {
      ...
      return possessor?.number === "plural" || ["to", "amo", "in"].includes(prefix);
    }
    ...
    function buildOrdinaryNncOpenStemPossessiveSourceFrame({
      ...
      const pluralPossessorSuffix = normalizedAnimacy === "animate" && isOrdinaryNncPluralPossessor(resolvedPossessor) ? "huān" : "";
    ...
    function buildOrdinaryNncOpenStemPossessiveOperationFrame(sourceFrame = null) {
      ...
      const targetPossessorSurface = String(sourceFrame.possessorPrefix || "");
      ...
      const soundSpellingFrames = Object.freeze([]);
      const targetFrame = Object.freeze({
    ...
    function buildOrdinaryNncAnimateDistributiveSourceFrame({
      ...
      const numberConnectorSurface = "meh";
    ...
    function buildOrdinaryNncAnimateCountPluralOperationFrame(sourceFrame = null) {
      ...
      const targetSubjectSurface = String(sourceFrame.subjectPrefix || "");
    ...
    function buildOrdinaryNncPossessiveDistributiveSourceFrame({
      ...
      const possessorPrefix = String(resolvedPossessor?.prefix || "").trim();
      const possessorNumber = String(resolvedPossessor?.number || "").trim();
      const pluralPossessorSuffix = isOrdinaryNncPluralPossessor(resolvedPossessor) ? "huān" : "";
      const syllables = normalizedSourceStem && typeof targetObject.splitVerbSyllables === "function" ? targetObject.splitVerbSyllables(normalizedSourceStem) : [];
      const syllableFrames = (Array.isArray(syllables) ? syllables : []).map((syllable, index) => ({
    ...
    function buildOrdinaryNncAnimatePossessiveCountPluralOperationFrame(sourceFrame = null) {
      ...
      const possessorSoundSpellingFrames = [];
    ...
    function buildOrdinaryNncDerivedPluralForms(singularForms = [], {
      ...
      const distributiveResults = distributiveSourceEntries.map(entry => {
        ...
        ...entry,
        surface: animacy === "animate" ? `${entry.surface}meh` : entry.surface
      })).map(entry => {
    ...
    function normalizeOrdinaryNncNum1Num2Class(nounClass = "") {
      return normalizeOrdinaryNncNounClass(nounClass);
    }
    ...
    function buildOrdinaryNncNum1Num2Dyad({
      ...
      if (normalizedNumber === "plural" && normalizedPluralType === ORDINARY_NNC_PLURAL_TYPE.count) {
        return {
          ...
          compactDisplay: "meh",
          compactSurface: "meh",
          source: "andrews-12.3-animate-count-plural-m-eh"
        };
      }
    ...
    function parseOrdinaryNncPredicateFormulaInput(value = "", {
      ...
      const match = raw.match(/^\(\s*([^()]+?)\s*\)\s*(tli|tl|li|t|in|0|ø|zero)?$/i);
      if (!match) {
        return null;
      }
      ...
      const formulaClass = String(match[2] || "zero").toLowerCase();
      const nounClass = normalizeOrdinaryNncNum1Num2Class(formulaClass === "t" ? "tl" : formulaClass === "li" ? "tli" : formulaClass) || "zero";
      return {
        stem,
        nounClass,
    ...
    function isOrdinaryNncLegacyFormulaString(value = "") {
      ...
      const predicateMatch = raw.match(/^\(\s*([^()]+?)\s*\)\s*(tli|tl|li|t|in|0|ø|zero)?$/i);
    ...
    function buildOrdinaryNncBasicMetadata({
      ...
      const referenceLabel = !isPlural ? "referencia comun" : effectivePluralType === ORDINARY_NNC_PLURAL_TYPE.count ? "plural -meh" : "distributivo";
      ...
      return {
        ...
        reference: {
          ...
          countSuffix: isPlural && isAnimate && effectivePluralType === ORDINARY_NNC_PLURAL_TYPE.count ? "meh" : "",
          animateCountSuffix: isAnimate ? "meh" : "",
    ...
    function generateOrdinaryNncParadigm(request = {}) {
      const stem = getOrdinaryNncOwnDataPropertyValue(request, "stem", "");
      const state = getOrdinaryNncOwnDataPropertyValue(request, "state", "");
      const subject = getOrdinaryNncOwnDataPropertyValue(request, "subject", null);
      const possessor = getOrdinaryNncOwnDataPropertyValue(request, "possessor", null);
      const possessivePrefix = getOrdinaryNncOwnDataPropertyValue(request, "possessivePrefix", "");
      const number = getOrdinaryNncOwnDataPropertyValue(request, "number", "singular");
      const pluralType = getOrdinaryNncOwnDataPropertyValue(request, "pluralType", ORDINARY_NNC_PLURAL_TYPE.auto);
      const nounClass = getOrdinaryNncOwnDataPropertyValue(request, "nounClass", "");
      const animacy = getOrdinaryNncOwnDataPropertyValue(request, "animacy", "");
      const possessionKind = getOrdinaryNncOwnDataPropertyValue(request, "possessionKind", "");
      const stateCase = getOrdinaryNncOwnDataPropertyValue(request, "stateCase", "");
      const possessionType = getOrdinaryNncOwnDataPropertyValue(request, "possessionType", "");
      ...
      const normalizedStem = hasLegacyFormulaString ? "" : plainStem;
      const rawRequestedNounClass = nounClass || "";
      const nounClassSelectionFrame = buildOrdinaryNncNounClassSelectionFrame(rawRequestedNounClass, {
        ...
        provenance: nounClass ? "request" : "absent"
      });
      ...
      const authorityCarrierKeys = getOrdinaryNncRequestAuthorityCarrierKeys(request);
      if (authorityCarrierKeys.length) {
        return {
          ...buildOrdinaryNncUnsupportedResult({
            ...
            nounClass: requestedNounClass || String(nounClass || ""),
            animacy,
            diagnostic: buildOrdinaryNncDiagnostic(ORDINARY_NNC_DIAGNOSTIC_IDS.authorityCarrierRejected, `Ordinary NNC generation rejects caller-supplied projection or result authority carriers: ${authorityCarrierKeys.join(", ")}.`)
          }),
      ...
      if (nounClassSelectionFrame.authorizationStatus === "blocked") {
        return buildOrdinaryNncUnsupportedResult({
          ...
          animacy,
          diagnostic: buildOrdinaryNncDiagnostic(ORDINARY_NNC_DIAGNOSTIC_IDS.unsupportedNounClass, `Ordinary NNC noun class "${nounClassSelectionFrame.requestedValue}" is not recognized by the Classical inventory.`)
        });
      }
      if (hasLegacyFormulaString) {
        return buildOrdinaryNncUnsupportedResult({
          stem: legacyFormulaInput?.stem || plainStem,
          state: normalizedState,
          number: normalizedNumber,
          pluralType: normalizedNumber === "plural" ? normalizedPluralType : "",
          subject: resolvedSubject,
          possessor: resolvedPossessor?.unsupported ? null : resolvedPossessor,
          nounClass: requestedNounClass || legacyFormulaInput?.nounClass || "",
          animacy,
          diagnostic: buildOrdinaryNncDiagnostic(ORDINARY_NNC_DIAGNOSTIC_IDS.legacyFormulaStringBlocked, "Ordinary NNC generation does not let formula-looking strings authorize or infer grammar; pass the typed predicate stem and lexical noun class as Source constituents.")
        });
      }
      if (normalizedPossessionKind === ORDINARY_NNC_POSSESSION_KIND.organic) {
        const organicNounClass = requestedNounClass || "tl";
        ...
        const organicSourceFrame = buildOrdinaryNncOrganicPossessionSourceFrame({
          sourceStem: normalizedStem,
          possessor: resolvedPossessor?.unsupported ? null : resolvedPossessor,
        ...
        if (!organicSourceFrame) {
          return {
            ...buildOrdinaryNncUnsupportedResult({
              ...
              openStem: true,
              diagnostic: buildOrdinaryNncDiagnostic(ORDINARY_NNC_DIAGNOSTIC_IDS.organicPossessionMissingSourceFrame, "Organic possession NNC generation requires a typed predicate stem Source constituent.")
            }),
            possessionKind: normalizedPossessionKind,
            source: {
              fixtureId: "",
        ...
        const organicOperationFrame = buildOrdinaryNncOrganicPossessionOperationFrame(organicSourceFrame);
      ...
      if (!resolvedSurfaceForms.length) {
        ...
        const diagnosticMessage = missingPossessiveState ? `No nominal nuclear clause possessive forms are configured for stem "${fixture.stem || normalizedStem}".` : diagnosticId === ORDINARY_NNC_DIAGNOSTIC_IDS.unsupportedPluralType ? `Nominal nuclear clause ${isOpenStemFixture ? "open stem" : "fixture"} "${fixture.stem || normalizedStem}" is nonanimate; plural count -meh is only configured for animate nouns.` : `No nominal nuclear clause ${normalizedState} ${normalizedNumber} form is configured for stem "${fixture.stem || normalizedStem}".`;
        return buildOrdinaryNncUnsupportedResult({
          stem: fixture.stem || normalizedStem,
          state: normalizedState,
          number: normalizedNumber,
    ...
    function generateOrdinaryNncParadigmSet(request = {}) {
      const stem = getOrdinaryNncOwnDataPropertyValue(request, "stem", "");
      const states = getOrdinaryNncOwnDataPropertyValue(request, "states", null);
      const numbers = getOrdinaryNncOwnDataPropertyValue(request, "numbers", null);
      const pluralTypes = getOrdinaryNncOwnDataPropertyValue(request, "pluralTypes", null);
      const possessors = getOrdinaryNncOwnDataPropertyValue(request, "possessors", null);
      const subject = getOrdinaryNncOwnDataPropertyValue(request, "subject", null);
      const nounClass = getOrdinaryNncOwnDataPropertyValue(request, "nounClass", "");
      const animacy = getOrdinaryNncOwnDataPropertyValue(request, "animacy", "");
      ...
      const authorityCarrierKeys = getOrdinaryNncRequestAuthorityCarrierKeys(request);
      if (authorityCarrierKeys.length) {
        const directResult = generateOrdinaryNncParadigm(request);
        return {
          ...buildOrdinaryNncParadigmSetResult({
            supported: false,
            stem: directResult.stem || normalizedStem,
            nounClass: directResult.nounClass || requestedNounClass,
            animacy,
            entries: [],
    ...
    function buildOrdinaryNncFormulaWorkbenchSlice({
      ...
      const generationAllowed = Boolean(result?.supported === true);
      ...
      return {
        ...
        generation: {
          ...
          authorizationPath: generationAllowed ? "typed-source-to-canonical-ordinary-nnc-result" : "blocked",
          resultKind: result?.outputKind || "",
          blockedReasons: generationAllowed ? [] : (Array.isArray(result?.diagnostics) ? result.diagnostics.map(diagnostic => diagnostic?.id || "").filter(Boolean) : []),
    ...
    const POSSESSIVE_STATE_NNC_SPECIFIC_POSSESSOR_SPECS = Object.freeze({
      no: Object.freeze({
        ...
        classicalFormula: "n-o",
        classicalRealization: "no",
        gloss: "my",
        source: "Andrews 13.6 + current Classical possessor prefix"
      }),
      to: Object.freeze({
        id: "1pl",
        personSubKey: "1pl",
        andrewsStructural: "t-o",
        classicalFormula: "t-o",
        classicalRealization: "to",
        gloss: "our",
        source: "Andrews 13.6 + current Classical possessor prefix"
      }),
      mo: Object.freeze({
        ...
        classicalFormula: "m-o",
        classicalRealization: "mo",
        gloss: "your (sg)",
        source: "Andrews 13.6 + current Classical possessor prefix"
      }),
      amo: Object.freeze({
        ...
        classicalFormula: "am-o",
        classicalRealization: "amo",
        gloss: "your (pl)",
        source: "Andrews 13.6 + current Classical possessor prefix"
      }),
      "ī": Object.freeze({
        ...
        classicalFormula: "i-Ø",
        classicalRealization: "ī",
        gloss: "his/her/its",
        source: "Andrews 13.6 + current Classical possessor prefix"
      }),
      in: Object.freeze({
        ...
        classicalFormula: "i-n",
        classicalRealization: "in",
        gloss: "their",
        source: "Andrews 13.6 + current Classical possessor prefix"
      })
    });
    const POSSESSIVE_STATE_NNC_MONADIC_POSSESSOR_SPECS = Object.freeze({
      "tē": Object.freeze({
        ...
        andrewsStructural: "tē",
        classicalRealization: "tē",
        gloss: "someone's",
        source: "Andrews 13.4",
    ...
    function getPossessiveStateNncSpecificPossessorSpec(prefix = "no") {
      const normalized = String(prefix || "no").trim();
      return POSSESSIVE_STATE_NNC_SPECIFIC_POSSESSOR_SPECS[normalized] || POSSESSIVE_STATE_NNC_SPECIFIC_POSSESSOR_SPECS.no;
    }
    function getPossessiveStateNncMonadicPossessorSpec(key = "tē") {
      const normalized = String(key || "tē").trim();
      return POSSESSIVE_STATE_NNC_MONADIC_POSSESSOR_SPECS[normalized] || POSSESSIVE_STATE_NNC_MONADIC_POSSESSOR_SPECS.tē;
    }
    function buildPossessiveStateNncStateSlot({
      ...
      const classicalFormulaDisplay = spec.classicalFormula || spec.classicalDisplay || spec.classicalRealization || structuralDisplay;
      const compactDisplay = spec.classicalRealization || classicalFormulaDisplay;
      return {
        ...
        classicalRealization: classicalFormulaDisplay,
        classicalDisplay: classicalFormulaDisplay,
        compactDisplay,
    ...
    function buildPossessiveStateNncFormulaEchoFromSlots(formulaSlots = null, {
      ...
      const displayState = mode === "compact" ? stateSlot.compactDisplay || stateSlot.surface || stateSlot.classicalDisplay || stateSlot.classicalRealization || stateSlot.display || "" : mode === "classical" ? stateSlot.classicalDisplay || stateSlot.classicalRealization || stateSlot.compactDisplay || stateSlot.display || "" : stateSlot.structuralDisplay || stateSlot.andrewsStructural || stateSlot.display || "";
      const numberConnector = formulaSlots.num1Num2 || {};
    ...
    function buildPossessiveStateNncFormulaWorkbenchSlotRecords(schema = null, formulaSlots = {}) {
      ...
      return slots.map(slot => {
        ...
        const classicalValue = slot.key === "possessiveState" ? String(sourceSlot.classicalDisplay || sourceSlot.classicalRealization || sourceSlot.compactDisplay || structuralValue) : slot.key === "num1Num2" || slot.id === "num1-num2" ? String(sourceSlot.displayDyad || structuralValue || "Ø") : structuralValue;
        const compactValue = slot.key === "num1Num2" || slot.id === "num1-num2" ? String(sourceSlot.compactDisplay || sourceSlot.connector || sourceSlot.surface || "Ø") : slot.key === "possessiveState" ? String(sourceSlot.compactDisplay || classicalValue || structuralValue) : structuralValue;
    ...
    function buildPossessiveStateNncFormulaWorkbenchExample({
      ...
      const normalizedStem = normalizeOrdinaryNncText(stem).replace(/[()]/g, "") || "chichi";
      ...
      const classicalFormulaEcho = buildPossessiveStateNncFormulaEchoFromSlots(formulaSlots, {
        mode: "classical",
        expanded: true
      });
    ...
    function buildPossessiveStateNncFormulaWorkbenchExamples(stem = "chichi") {
      const normalizedStem = normalizeOrdinaryNncText(stem).replace(/[()]/g, "") || "chichi";
      ...
      return [buildPossessiveStateNncFormulaWorkbenchExample({
        id: "specific-1sg-no-chichi",
        label: "specific 1sg",
        stem: normalizedStem,
        possessorKind: "specific",
        possessor: "no"
      }), buildPossessiveStateNncFormulaWorkbenchExample({
        id: "monadic-human-te-chichi",
    ...
    function buildPossessiveStateNncFormulaWorkbenchSlice({
      ...
      const classicalFormulaEcho = buildPossessiveStateNncFormulaEchoFromSlots(resultSlots, {
        mode: "classical",
        expanded: true
      });
      ...
      return {
        ...
        examples: buildPossessiveStateNncFormulaWorkbenchExamples(normalizedStem || "chichi"),
        evidenceRefs: [...(Array.isArray(schema?.evidenceRefs) ? schema.evidenceRefs : []), ...(Array.isArray(result?.source?.sourceRefs) ? result.source.sourceRefs : [])].filter(Boolean),
        realizationBoundary: {
          structuralFormulaEcho,
          classicalFormulaEcho,
          ...
          classicalStructuralOnly: true,
          noClassicalSurfaceImport: true,
          structuralExamples: ["hu-ān", "uh-0", "hui-0"],
          classicalAuthority: "Typed contextual Classical realization; examples illustrate spelling only and do not gate grammar logic"
        },
        generation: {
          allowed: generationAllowed,
          status: generationStatus,
        ...
        diagnostics: [...(Array.isArray(sourceRequirementCheck.diagnostics) ? sourceRequirementCheck.diagnostics : []), ...resultDiagnostics, ...slotBlockDiagnostics, ...numBlockDiagnostics, {
          ...
          severity: "note",
          message: "Andrews hu-ān, uh-0, and hui-0 are structural connector evidence; typed operations realize their Classical surfaces contextually."
        }]
      };
    }
    ...
    function buildSubjectNumberConnectorFormulaWorkbenchSlotRecords(schema = null, {
      ...
      return slots.map(slot => {
        ...
        const classicalValue = slot.key === "num1Num2" || slot.id === "num1-num2" ? numberClassical : structuralValue;
    ...
    function buildSubjectNumberConnectorOrdinaryExample({
      ...
      const classicalFormulaEcho = buildOrdinaryNncExpandedFormulaEchoFromSlots(formulaSlots);
      ...
      return {
        ...
        connectorClassical: connector.displayDyad || "",
        connectorCompact: connector.compactDisplay || connector.connector || "",
    ...
    function buildSubjectNumberConnectorPossessiveExample({
      ...
      const example = buildPossessiveStateNncFormulaWorkbenchExample({
        id: "possessive-specific-1sg-no-chichi",
      ...
      return {
        ...
        connectorClassical: example.formulaSlots?.num1Num2?.displayDyad || "",
    ...
    function buildSubjectNumberConnectorVncExample() {
      ...
      return {
        ...
        classicalFormulaEcho: vncSlice?.classicalFormulaEcho || "",
        ...
        connectorClassical: numberSlot.classicalValue || "",
        ...
        valenceClassical: valenceSlot.classicalValue || "",
    ...
    function buildSubjectNumberConnectorFormulaWorkbenchExamples(stem = "chichi") {
      const normalizedStem = normalizeOrdinaryNncText(stem).replace(/[()]/g, "") || "chichi";
      return [buildSubjectNumberConnectorOrdinaryExample({
        ...
        structuralConnectorSource: "Andrews 12.3 plural subject connector m-eh"
    ...
    function buildSubjectNumberConnectorFormulaWorkbenchSlice({
      ...
      return {
        ...
        classicalFormulaEcho: activeOrdinary.classicalFormulaEcho,
        ...
        parsedSlots: buildSubjectNumberConnectorFormulaWorkbenchSlotRecords(schema, {
          ...
          numberClassical: activeOrdinary.connectorClassical || "Ø-Ø",
        ...
        realizationBoundary: {
          ...
          surfaceAuthority: "Andrews transcription: m-eh for animate count plural and c-0/qu-0/qui-0 for scoped VNC number"
        },
        generation: {
        ...
        diagnostics: [...slotBlockDiagnostics, {
          ...
          severity: "note",
          message: "pers1-pers2 and num1-num2 are modeled as dyads even when compact display collapses zero or fused Classical realization."
        }]
      };
    }
    ...
    function resolveClassicalPossessorPrefixFromSourceSubject(subjectPrefix = "", subjectSuffix = "") {
      ...
      if (prefix === "ti" && suffix === "h") {
        return "to";
      }
      if (prefix === "am" && suffix === "h") {
        return "amo";
      }
      if (prefix === "" && suffix === "h") {
        return "in";
    ...
    function resolveInstrumentivoPossessorPrefixFromSourceSubject(subjectPrefix = "", subjectSuffix = "") {
      return resolveClassicalPossessorPrefixFromSourceSubject(subjectPrefix, subjectSuffix);
    }
    ...
    function resolveInstrumentivoCanonicalNonactiveOptions(sourceStem = "", {
      sourceValence = "",
      fallbackOptions = []
    } = {}) {
      const normalizedSourceStem = targetObject.normalizeDerivationStemValue(sourceStem);
      const fallback = Array.isArray(fallbackOptions) ? fallbackOptions : [];
      if (normalizedSourceStem !== "nemi") {
        return {
          options: fallback,
      ...
      if (typeof targetObject.getClassicalNahuatlNonactiveStemOptions !== "function" || typeof targetObject.deriveClassicalNahuatlNonactiveStemRecord !== "function" || typeof targetObject.isClassicalNahuatlNonactiveStemRecord !== "function") {
        return {
          options: [],
          nonactiveStemRecord: null,
      ...
      const inventory = targetObject.getClassicalNahuatlNonactiveStemOptions(normalizedSourceStem, {
        sourceValence: String(sourceValence || "intransitive")
      });
      if (inventory?.authorizationStatus !== "authorized" || inventory?.selectionRequired === true || inventory?.options?.length !== 1) {
        return {
          options: [],
          nonactiveStemRecord: null,
          canonicalRequired: true,
      ...
      const nonactiveStemRecord = targetObject.deriveClassicalNahuatlNonactiveStemRecord(normalizedSourceStem, {
        sourceValence: String(sourceValence || "intransitive"),
        optionId: option.optionId
      });
      if (!targetObject.isClassicalNahuatlNonactiveStemRecord(nonactiveStemRecord, normalizedSourceStem) || nonactiveStemRecord.nonactiveStem !== "nem-o-hua" || nonactiveStemRecord.selectedRuleId !== "cn-l20-5-intransitive-final-mi") {
        return {
          options: [],
          nonactiveStemRecord: null,
          canonicalRequired: true,
      ...
      const boundarylessStem = String(nonactiveStemRecord.nonactiveStem || "").replace(/-/gu, "");
      return {
        options: [{
          suffix: nonactiveStemRecord.suffixFamily,
          stem: boundarylessStem,
          stemSpec: targetObject.buildLiteralMorphStemSpec(boundarylessStem),
    ...
    function resolvePredicateNominalAbsolutiveTlTliConnector(value = "", fallback = "tl", options = {}) {
      ...
      if (!finalLetter) {
        return String(fallback || "tl");
      }
      return /[aeiouāēīō]/u.test(finalLetter) ? "tl" : finalLetter === "l" ? "li" : "tli";
    }
    function shouldResolvePredicateNominalConnectorAsTlTli(connector = "") {
      return ["", "tl", "tli", "li"].includes(String(connector || ""));
    }
    ...
    function buildPredicateNominalConnectorOperationFrame({
      ...
      nominalConnector = "tl",
      operationId = "andrews-36-6-note-2-predicate-nominal-absolutive-tl-tli-connector",
      andrewsRef = "Andrews 36.6 note 2"
    } = {}) {
      const resolvedOperationId = String(operationId || "").trim() || "andrews-36-6-note-2-predicate-nominal-absolutive-tl-tli-connector";
      return Object.freeze({
        version: 1,
        kind: "andrews-predicate-nominal-connector-operation-frame",
        operationId: resolvedOperationId,
        operationApplied: "derive-target-absolutive-tl-tli-from-source-predicate-stem-frame",
        ...
        requestedConnector: String(nominalConnector || "tl").trim(),
        targetConnectorFamily: "tl/tli",
    ...
    function getPredicateNominalConnectorOperationFrameMismatch({
      ...
      if (String(operationFrame.targetConnectorFamily || "") !== "tl/tli") {
        return "contradictory-operation-frame";
      }
      ...
      const requestedConnector = String(nominalConnector || "tl").trim();
      if (!shouldResolvePredicateNominalConnectorAsTlTli(requestedConnector)) {
        return "";
      }
      const frameRequestedConnector = String(operationFrame.requestedConnector || "tl").trim();
      if (!shouldResolvePredicateNominalConnectorAsTlTli(frameRequestedConnector)) {
        return "contradictory-operation-frame";
      }
      return "";
    }
    function resolvePredicateNominalAbsolutiveTlTliConnectorFromFrame({
      operationFrame = null,
    ...
    function getPredicateNominalResult({
      ...
      const connector = String(nominalConnector || "tl");
      const resolveTlTliConnector = shouldResolvePredicateNominalConnectorAsTlTli(connector);
      if (resolveTlTliConnector) {
      ...
      forwardStemContexts.forEach(stemContext => {
        ...
        const sourceObjectPrefix = isNonactive ? nonactivePassiveObjectPrefix : stemContext.morphologyObjectPrefix === "mo" ? "ne" : stemContext.morphologyObjectPrefix;
        sourceStemEntries.forEach(sourceStemEntry => {
          ...
          const resolvedConnector = resolveTlTliConnector ? resolvePredicateNominalAbsolutiveTlTliConnectorFromFrame({
            operationFrame: predicateNominalConnectorOperationFrame,
            predicateStemSpec,
            fallback: connector || "tl"
          }) : connector;
          if (resolveTlTliConnector && !resolvedConnector) {
            return;
          }
          entries.push(targetObject.buildVerbDerivedNominalEntry({
            ...
            metadata: {
              ...
              sourceTenseSuffix,
              absolutiveConnectorFamily: resolveTlTliConnector ? "tl/tli" : "",
              ...
              absolutiveConnectorOperationFrame: resolveTlTliConnector ? predicateNominalConnectorOperationFrame : null
            }
          }));
        });
      });
      ...
      return attachVerbDerivedNominalGrammarContract({
        ...
        predicateNominalSource: {
          ...
          sourceUnit: "vnc-predicate",
          sourceTense: resolvedSourceTense,
          connectorClass: connector || "tl",
          connectorFamily: resolveTlTliConnector ? "tl/tli" : connector,
          connectorSelector: resolveTlTliConnector ? "typed-predicate-stem-frame-previous-non-zero-segment" : ""
        },
        predicateNominalConnectorOperationFrame: resolveTlTliConnector ? predicateNominalConnectorOperationFrame : null
      }, {
        kind: resolvedNominalKind,
        rawVerb
      });
    ...
    Object.defineProperty(api, "NNC_LESSON12_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return NNC_LESSON12_CANVAS_REFS; },
    });
    ...
    Object.defineProperty(api, "NNC_LESSON13_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return NNC_LESSON13_CANVAS_REFS; },
    });
    ...
    Object.defineProperty(api, "NNC_LESSON14_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return NNC_LESSON14_CANVAS_REFS; },
    });
    ...
    Object.defineProperty(api, "NNC_LESSON15_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return NNC_LESSON15_CANVAS_REFS; },
    });
    ...
    Object.defineProperty(api, "NNC_LESSON16_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return NNC_LESSON16_CANVAS_REFS; },
    });
    ...
    api.getNncFormulaContrastFrame = getNncFormulaContrastFrame;
    api.getNncAbsolutiveFormulaFrame = getNncAbsolutiveFormulaFrame;
    api.getNncAbsolutiveSubjectPositionFrame = getNncAbsolutiveSubjectPositionFrame;
    api.getNncAbsolutiveSubjectPronounInventoryFrame = getNncAbsolutiveSubjectPronounInventoryFrame;
    api.getNncPredicateFrame = getNncPredicateFrame;
    api.getNncAnimacyFrame = getNncAnimacyFrame;
    api.getNncStateNounstemFrame = getNncStateNounstemFrame;
    api.getNncAbsolutiveSubsectionInventory = getNncAbsolutiveSubsectionInventory;
    api.getNncAbsolutiveRemainingGaps = getNncAbsolutiveRemainingGaps;
    api.getNncPossessiveFormulaFrame = getNncPossessiveFormulaFrame;
    api.getNncPossessiveSubjectPositionFrame = getNncPossessiveSubjectPositionFrame;
    api.getNncPossessiveSubjectPronounInventoryFrame = getNncPossessiveSubjectPronounInventoryFrame;
    api.getNncMonadicStateFrame = getNncMonadicStateFrame;
    api.getNncDyadicStateFrame = getNncDyadicStateFrame;
    api.getNncSpecificPossessorFrame = getNncSpecificPossessorFrame;
    api.getNncPossessiveSubsectionInventory = getNncPossessiveSubsectionInventory;
    api.getNncPossessiveRemainingGaps = getNncPossessiveRemainingGaps;
    api.getNncUseStemFrame = getNncUseStemFrame;
    api.getNncNounstemClassFrame = getNncNounstemClassFrame;
    api.getNncNounstemNumberFrame = getNncNounstemNumberFrame;
    api.getNncAbsolutiveSingularCommonFrame = getNncAbsolutiveSingularCommonFrame;
    api.getNncAbsolutivePluralFrame = getNncAbsolutivePluralFrame;
    api.getNncPossessivePluralFrame = getNncPossessivePluralFrame;
    api.getNncPossessiveSingularCommonFrame = getNncPossessiveSingularCommonFrame;
    api.getNncConstituentAnalysisFrame = getNncConstituentAnalysisFrame;
    api.getNncNounstemSubsectionInventory = getNncNounstemSubsectionInventory;
    api.getNncNounstemRemainingGaps = getNncNounstemRemainingGaps;
    api.getNncPossessivePeculiaritiesFrame = getNncPossessivePeculiaritiesFrame;
    api.getNncNaturallyPossessedFrame = getNncNaturallyPossessedFrame;
    api.getNncSentenceStructureFrame = getNncSentenceStructureFrame;
    api.getNncOrdinarySubsectionInventory = getNncOrdinarySubsectionInventory;
    api.getNncOrdinaryRemainingGaps = getNncOrdinaryRemainingGaps;
    api.getNncOverviewFrame = getNncOverviewFrame;
    api.getNncEntitiveFrame = getNncEntitiveFrame;
    api.getNncPersonalFrame = getNncPersonalFrame;
    api.getNncInterrogativeFrame = getNncInterrogativeFrame;
    api.getNncDemonstrativeFrame = getNncDemonstrativeFrame;
    api.getNncIndefiniteFrame = getNncIndefiniteFrame;
    api.getNncQuantitiveOverviewFrame = getNncQuantitiveOverviewFrame;
    api.getNncQuichFrame = getNncQuichFrame;
    api.getNncQuiChiFrame = getNncQuiChiFrame;
    api.getNncPronominalSubsectionInventory = getNncPronominalSubsectionInventory;
    api.getNncPronominalRemainingGaps = getNncPronominalRemainingGaps;
    ...
    api.normalizeOrdinaryNncNounClass = normalizeOrdinaryNncNounClass;
    ...
    api.getOrdinaryNncRequestAuthorityCarrierKeys = getOrdinaryNncRequestAuthorityCarrierKeys;
    ...
    api.resolveClassicalPossessorPrefixFromSourceSubject = resolveClassicalPossessorPrefixFromSourceSubject;
    ...
    api.resolvePredicateNominalAbsolutiveTlTliConnector = resolvePredicateNominalAbsolutiveTlTliConnector;
    api.shouldResolvePredicateNominalConnectorAsTlTli = shouldResolvePredicateNominalConnectorAsTlTli;
    ...
    api.resolvePredicateNominalAbsolutiveTlTliConnectorFromFrame = resolvePredicateNominalAbsolutiveTlTliConnectorFromFrame;
...
export function installNncGlobals(targetObject = globalThis, installationContext = null) {
    const api = createNncApi(targetObject, installationContext);
