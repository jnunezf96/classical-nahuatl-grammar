...
export function createAgreementModule(targetObject = globalThis, installationContext = null) {
    ...
    const LESSON23_VERB_OBJECTS_CANVAS_REFS = Object.freeze(["Andrews Lesson 23.1", "Andrews Lesson 23.2", "Andrews Lesson 23.3", "Andrews Lesson 23.4", "Andrews Lesson 23.5"]);
    ...
    const LESSON23_OBJECT_SEQUENCE_FRAME = Object.freeze({
      ...
      andrewsThreeObjectCombinations: Object.freeze([Object.freeze(["tla", "tla", "tla"]), Object.freeze(["tē", "tla", "tla"]), Object.freeze(["m-o", "tla", "tla"]), Object.freeze(["tē", "tē", "tla"]), Object.freeze(["m-o", "tē", "tla"]), Object.freeze(["c-0", "m-o", "tla"]), Object.freeze(["tē", "tē", "tē"]), Object.freeze(["m-o", "tē", "tē"]), Object.freeze(["c-0", "m-o", "tē"]), Object.freeze(["c-0", "0-0", "tla"]), Object.freeze(["c-0", "0-0", "tē"]), Object.freeze(["c-0", "0-0", "m-o"]), Object.freeze(["c-0", "0-0", "0-0"])]),
      classicalObjectMorphs: Object.freeze(["tla", "tē", "n-o/t-o/m-o", "c/qu/qui"]),
      appendixCInventoryNeededForClosestPass: false
    });
    const LESSON23_VERB_OBJECTS_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      ...
      redirectAction: "canonical-engine"
    }), Object.freeze({
    ...
    function getVerbObjectsSubsectionInventory() {
      return LESSON23_VERB_OBJECTS_SUBSECTION_INVENTORY.map(entry => ({
        ...entry,
        canvasRef: `Andrews Lesson ${entry.andrewsSection}`,
        evidenceStatus: "direct-canvas-source-span-verified",
        orthographyStatus: "classical-andrews-transcription-verified",
    ...
    function getPers1Pers2Info(pers1, pers2, options = {}) {
      ...
      if (optativeInfo && (isOptativePers1Pers2IdentityContext(options) || pers1 === "x" || pers1 === "xi" || pers2 === "ān")) {
        return optativeInfo;
      }
    ...
    function applyObj2ToObj1Chain(obj1, obj2) {
      ...
      let combined = "";
      if (targetObject.SPECIFIC_VALENCE_PREFIX_SET.has(obj2)) {
        if (!obj1) {
          combined = obj2;
        } else if (targetObject.SPECIFIC_VALENCE_PREFIX_SET.has(obj1)) {
          combined = obj2;
        } else {
          combined = `${obj1}${obj2}`;
        }
    ...
    function isSpecificProjectivePrefix(prefix) {
      return targetObject.SPECIFIC_VALENCE_PREFIX_SET.has(prefix);
    }
    ...
    function normalizeValenceMarkerOrder(prefix) {
      ...
      const markerInventory = Array.from(new Set([...targetObject.SPECIFIC_VALENCE_PREFIXES, ...targetObject.NONSPECIFIC_VALENCE_PREFIXES])).sort((a, b) => b.length - a.length);
      const tokenEntries = [];
      let working = rest;
      let tokenIndex = 0;
      while (working) {
    ...
    function resolveObj1Obj2Positions({
      ...
      if (allowSpecificWithNonspecific && obj2 === "mo") {
        return {
          obj1,
          obj2
        };
      }
      const isSpecific = prefix => targetObject.SPECIFIC_VALENCE_PREFIX_SET.has(prefix);
      const isNonspecific = prefix => targetObject.NONSPECIFIC_VALENCE_AFFIX_SET.has(prefix);
      const isReflexive = prefix => prefix === "mo";
      const keepReflexiveObj2 = allowSpecificWithNonspecific && obj2 === "mo";
      if (isApplicative) {
    ...
    function resolveDisplayObj1Obj2({
      ...
      if ((derivationType === targetObject.DERIVATION_TYPE.applicative || derivationType === targetObject.DERIVATION_TYPE.causative) && nextObj2) {
        const isSpecific = prefix => isSpecificProjectivePrefix(prefix) || prefix === "mo";
    ...
    function getAgreementConjugationGrammarFrame(result = null) {
    ...
    function getConjugationRenderableSurfaceForms(result = null) {
      const grammarFrame = getAgreementConjugationGrammarFrame(result);
      return grammarFrame
    ...
    function resolveNominalAvailabilityProbeSelection({
      ...
      if (isPatientivoTroncoProbe && !normalizedObjectPrefix && verbMeta?.hasImpersonalTlaPrefix !== true) {
        const baseObjectSlots = Number(targetObject.getBaseObjectSlots(verbMeta));
        const isTransitiveBase = Number.isFinite(baseObjectSlots) && baseObjectSlots > 0 || verbMeta?.isMarkedTransitive === true || verbMeta?.isTlaFusion === true;
        if (isTransitiveBase) {
          normalizedObjectPrefix = "tla";
        }
      }
      return {
    ...
    function buildMorphologyMetaOptions(meta, overrides = {}) {
      return {
        ...
        hasImpersonalTlaPrefix: meta?.hasImpersonalTlaPrefix,
        ...
        isTlaFusion: meta?.isTlaFusion,
        indirectObjectMarker: meta?.indirectObjectMarker,
        isUnderlyingTransitive: meta?.isMarkedTransitive || meta?.isTlaFusion,
    ...
    function buildVerbDerivedNominalBuilderContext({
      ...
      if (verbMeta?.hasImpersonalTlaPrefix) {
    ...
    Object.defineProperty(api, "LESSON23_VERB_OBJECTS_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON23_VERB_OBJECTS_CANVAS_REFS; },
    });
    ...
    api.getVerbObjectsSubsectionInventory = getVerbObjectsSubsectionInventory;
...
export function installAgreementGlobals(targetObject = globalThis, installationContext = null) {
    const api = createAgreementModule(targetObject, installationContext);
