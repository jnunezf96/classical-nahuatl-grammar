...
const MORPHEME_COMMON_FACTS = Object.freeze([
  ...
  "carrier-content-amalgam-is-center-of-linguistic-duality",
  "smallest-duality-manifesting-unit",
  "linguistic-duality-defined-in-section-1.4",
  "notation-indicates-symbiotic-nature",
  "fraction-format-is-possible-morpheme-notation",
  ...
  "carrier-system-has-linguistic-existence-through-morphemes",
  "content-system-has-linguistic-existence-through-morphemes",
...
const CONCEPT_SPECS = Object.freeze([
  ...
  defineConceptSpec({
    ...
    facts: [
      ...
      "slash-notation-documents-type-level-item",
      "analyst-selects-type-representation-shape",
      "explanatory-power-guides-type-representation",
      "frequency-does-not-govern-type-representation",
    ...
    restrictions: [
      "slash-notation-does-not-authorize-type-identity",
      "frequency-does-not-select-the-type-representation",
    ],
  }),
  defineConceptSpec({
    domain: "analysis-level",
    ...
    facts: [
      ...
      "mental-construct",
      "square-bracket-notation-documents-token-level-item",
      "abstraction-derived-from-experienced-similarity-difference-correspondence-and-contrast",
    ],
    relations: [
    ...
    restrictions: [
      "square-bracket-notation-does-not-authorize-token-identity",
    ],
  }),
  defineConceptSpec({
    domain: "analysis-level",
    ...
    facts: [
      ...
      "instance-level-entities-are-too-variable-for-direct-grammar-description",
      "two-phone-instances-are-not-expected-to-be-exactly-alike",
      "instances-are-the-only-witnesses-to-hypothesized-abstract-levels",
      "abstract-levels-are-inferred-from-instances-by-extrapolation-and-generalization",
      "abstraction-factors-out-performance-variability",
    ],
    relations: ["manifests-token"],
    restrictions: [
      "quotation-mark-notation-does-not-authorize-instance-identity",
      "pronunciation-instance-evidence-does-not-authorize-token-identity",
    ],
  }),
  ...
  defineConceptSpec({
    ...
    facts: [
      ...
      "summary-chart-restates-sections-1.3-through-1.7",
      "phoneme-belongs-to-type-level",
      "grapheme-belongs-to-type-level",
      "sigeme-belongs-to-type-level",
      "sememe-belongs-to-type-level",
      "morpheme-belongs-to-type-level",
    ],
    relations: [
      "inventory-phoneme",
      "inventory-grapheme",
  ...
  defineConceptSpec({
    ...
    facts: [
      ...
      "phone-belongs-to-token-level",
      "graph-belongs-to-token-level",
      "sig-belongs-to-token-level",
      "seme-belongs-to-token-level",
      "morph-belongs-to-token-level",
    ],
    relations: [
  ...
  defineConceptSpec({
    ...
    facts: [
      ...
      "occurrence-level-silence-may-be-perceived-before-after-or-during-interruption",
      "occurrence-level-silence-is-pronunciational-and-audible",
      "audible-occurrence-silence-is-not-implicit-grammatical-sig-silence",
      "sound-belongs-to-instance-level",
      "letter-belongs-to-instance-level",
      "meaning-belongs-to-instance-level",
      "form-belongs-to-instance-level",
    ],
    relations: [
      "phones-represent-phonemes",
      "graphs-represent-graphemes",
  ...
  defineConceptSpec({
    domain: "phone-repertory-analysis",
    selection: "english-t-evidence",
    classification: "phone-repertory-evidence-check",
    semanticOwnerId: PHONE_REPERTORY_ANALYSIS_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "english-aspirated-and-unaspirated-t-are-nondistinctive-realizations",
      "mutually-exclusive-environments-prevent-phone-contrast",
      "english-unaspirated-t-occurs-after-s-where-aspirated-t-does-not",
    ],
    relations: ["english-t-witness-checks-noncontrastive-phone-model"],
    restrictions: PHONE_VARIANT_ANALYSIS_RESTRICTIONS,
  }),
  defineConceptSpec({
    domain: "phone-repertory-analysis",
  ...
  defineConceptSpec({
    domain: "phone-repertory-analysis",
    selection: "spanish-regular-s-evidence",
    classification: "phone-repertory-evidence-check",
    semanticOwnerId: PHONE_REPERTORY_ANALYSIS_OWNER_ID,
    factRole: "evidence-only",
    facts: ["spanish-s-example-checks-regular-phone-definition"],
    relations: ["foreign-regular-phone-witness-checks-phone-model"],
    restrictions: PHONE_VARIANT_ANALYSIS_RESTRICTIONS,
  }),
  defineConceptSpec({
    domain: "phone-repertory-analysis",
  ...
  defineConceptSpec({
    domain: "phone-repertory-analysis",
    selection: "spanish-irregular-z-evidence",
    classification: "phone-repertory-evidence-check",
    semanticOwnerId: PHONE_REPERTORY_ANALYSIS_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "spanish-z-can-be-slightly-irregular-phone-of-s",
      "spanish-mismo-is-cited-with-z-realization",
      "spanish-z-differs-from-s-by-added-voice",
    ],
    relations: ["foreign-irregular-phone-witness-checks-phone-model"],
    restrictions: PHONE_VARIANT_ANALYSIS_RESTRICTIONS,
  }),
  defineConceptSpec({
    domain: "phone-repertory-analysis",
  ...
  defineConceptSpec({
    domain: "morpheme",
    selection: "english-plural-morph-evidence",
    classification: "morph-token-evidence-check",
    semanticOwnerId: MORPH_TOKEN_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "english-s-is-cited-as-plural-number-morpheme",
      "english-s-plural-morpheme-has-more-than-one-content",
      "english-pits-cites-s-plural-carrier",
      "english-pigs-cites-z-plural-carrier",
      "english-kisses-cites-iz-plural-carrier-with-supportive-vowel",
      "english-oxen-cites-irregular-en-plural-carrier",
      "english-sheep-cites-zero-plural-carrier",
      "english-zero-plural-and-singular-share-shape-but-have-distinct-contextual-number-content",
    ],
    relations: ["english-plural-witnesses-check-regular-irregular-and-zero-morph-model"],
    restrictions: MORPH_TOKEN_CLASSIFICATION_RESTRICTIONS,
  }),
  defineConceptSpec({
    domain: "morpheme",
    selection: "borrowed-plural-morph-evidence",
    classification: "morph-token-evidence-check",
    semanticOwnerId: MORPH_TOKEN_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "borrowed-lexical-items-can-complicate-native-morph-analysis",
      "data-is-cited-with-nonnative-plural-morph",
      "seraphim-is-cited-with-nonnative-plural-morph",
      "amoebae-is-cited-with-nonnative-plural-morph",
    ],
    relations: ["borrowed-plural-witnesses-check-morph-analysis-boundary"],
    restrictions: MORPH_TOKEN_CLASSIFICATION_RESTRICTIONS,
  }),
  defineConceptSpec({
  ...
  defineConceptSpec({
    ...
    facts: [
      "single-lower-ranked-source",
      "set-may-have-one-member",
      "structural-complex-may-have-one-constituent",
    ],
    restrictions: [
  ...
  defineConceptSpec({
    ...
    facts: [
      ...
      "static-and-dynamic-facets",
      "set-may-have-more-than-one-member",
      "structural-complex-may-have-more-than-one-constituent",
      "structural-complex-normally-has-two-or-more-constituents",
    ],
  ...
  defineConceptSpec({
    domain: "structure",
    selection: "hierarchy-foundation",
    classification: "structural-hierarchy-foundation",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    facts: [
    ...
    restrictions: [
      "classification-does-not-form-a-higher-ranked-unit",
      "structural-unit-hierarchy-owner-is-separate",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "meaningful-hierarchy-comparison",
    classification: "documentary-meaningful-hierarchy-comparison",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "documentary-only",
    facts: [
      "section-1.11.2-presents-an-English-and-Spanish-meaningful-unit-hierarchy",
      "section-1.11.2-presents-a-Nahuatl-meaningful-unit-hierarchy",
      "the-two-hierarchies-are-juxtaposed-to-highlight-Nahuatl-rank-differences",
      "the-English-and-Spanish-scheme-ascends-morpheme-or-morph-root-stem-word-word-group-clause-clause-group-sentence",
    ],
    restrictions: [
      "the-comparison-does-not-authorize-English-or-Spanish-grammar",
      "the-displayed-schemes-do-not-authorize-a-Nahuatl-rank-result",
      "the-Nahuatl-meaningful-rank-hierarchy-owner-is-separate",
      "documentary-labels-do-not-create-rank-transitions",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "english-spanish-stem-formation-evidence",
    classification: "comparative-stem-formation-evidence",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "English-and-Spanish-stems-may-consist-of-a-root-alone",
      "duck-is-cited-as-an-English-root-alone-stem",
      "friend-is-cited-as-an-English-root-alone-stem",
      "English-and-Spanish-stems-may-consist-of-a-root-plus-one-or-more-derivational-affixes",
      "duck-ling-is-cited-as-an-English-root-plus-derivational-affix-stem",
      "friend-ly-is-cited-as-an-English-derived-stem",
      "un-friend-ly-is-cited-as-an-English-multiply-derived-stem",
      "un-friend-li-ness-is-cited-as-an-English-multiply-derived-stem",
    ],
    restrictions: [
      "comparative-examples-check-the-stem-model-without-authorizing-Nahuatl-formation",
      "example-spellings-do-not-become-lexical-input-or-output",
      "the-direct-Nahuatl-stem-formation-owner-is-separate",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "stem-post-stem-comparison-evidence",
    classification: "comparative-stem-post-stem-evidence",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "the-stem-to-next-rank-distance-is-greater-in-Nahuatl-than-in-English-or-Spanish",
      "the-English-and-Spanish-rank-above-stem-is-called-word",
      "Here-is-cited-as-a-simple-English-word-sentence",
      "Now-is-cited-as-a-simple-English-word-sentence",
      "Ouch-is-cited-as-a-simple-English-word-sentence",
      "English-one-word-sentences-are-exceptional-not-the-general-pattern",
      "English-one-word-sentences-normally-imply-at-least-one-unspoken-word",
      "Hush-can-imply-You-hush",
      "Now-can-imply-Do-it-now",
      "Here-can-imply-Put-it-here",
      "Do-it-now-is-the-fuller-structure-behind-Now",
      "Put-it-here-or-I-am-here-is-the-fuller-structure-behind-Here",
      "English-and-Spanish-words-may-be-paradigmatic-through-inflectional-suffixes",
      "dog-dogs-pick-picks-and-picked-check-paradigmatic-word-variation",
      "English-and-Spanish-words-may-be-nonparadigmatic-and-reject-inflection",
      "and-if-for-and-slowly-check-nonparadigmatic-English-words",
      "English-older-and-oldest-are-analyzed-as-derivational-not-inflectional",
      "German-comparative-and-superlative-stems-have-adjective-class-inflectional-paradigms",
      "a-nonparadigmatic-word-can-be-coextensive-in-form-with-its-stem",
      "a-nonparadigmatic-word-still-passes-through-stem-rank-before-word-rank",
      "when-a-stem-gives-rise-to-a-nonparadigmatic-word-the-form-is-coextensive",
      "Nahuatl-post-stem-rank-structure-differs-from-English-and-Spanish-word-rank",
      "Lesson-4-is-the-documentary-reference-for-Nahuatl-nuclear-clauses",
      "English-and-Spanish-words-remain-under-inflectional-morphology-rules",
    ],
    restrictions: [
      "comparative-evidence-does-not-install-English-Spanish-or-German-grammar",
      "quoted-utterances-and-reconstructed-words-do-not-authorize-a-sentence",
      "comparative-word-rank-does-not-authorize-Nahuatl-particle-or-nuclear-clause-status",
      "lesson-references-do-not-authorize-a-nuclear-clause-result",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "english-spanish-group-rank-evidence",
    classification: "comparative-group-rank-evidence",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "the-English-and-Spanish-syntactic-domain-begins-at-word-group-rank",
      "an-English-or-Spanish-word-group-contains-no-conjugated-verbword",
      "on-the-table-is-an-English-prepositional-word-group",
      "within-on-the-table-the-table-is-the-object-of-on",
      "an-English-or-Spanish-clause-group-contains-a-conjugated-verbword",
      "before-I-left-is-an-English-prepositional-clause-group",
      "within-before-I-left-I-left-is-the-object-of-before",
      "sections-3.4-and-15.3-and-Lesson-17-document-the-three-Nahuatl-group-shapes",
    ],
    restrictions: [
      "comparative-group-evidence-does-not-install-English-or-Spanish-grammar",
      "English-prepositional-examples-do-not-authorize-a-Nahuatl-group",
      "documentary-references-do-not-authorize-group-composition",
      "Nahuatl-group-composition-and-syntax-onset-require-their-own-owner-issued-results",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "english-concatenation-evidence",
    classification: "comparative-concatenation-evidence",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "English-syntax-is-used-only-to-illustrate-concatenation",
      "English-noun-plus-noun-forms-a-nominal-group-as-in-town-house",
      "English-adjective-plus-nominal-group-forms-a-nominal-group-as-in-new-town-house",
      "English-my-plus-new-town-house-forms-the-nominal-group-my-new-town-house",
      "English-of-is-the-preposition-in-the-cited-concatenation-example",
      "English-my-new-town-house-is-the-nominal-group-in-the-cited-example",
      "English-preposition-plus-nominal-group-forms-a-prepositional-group",
      "English-of-my-new-town-house-is-the-resulting-prepositional-group",
      "English-concatenation-terminology-does-not-authorize-Classical-Nahuatl-constituent-order",
    ],
    restrictions: [
      "English-examples-check-general-structure-without-authorizing-Nahuatl-grammar",
      "English-words-and-order-cannot-supply-Nahuatl-constituents-or-results",
      "the-linguistic-structure-principles-owner-remains-separate",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "english-adjunctive-governance-evidence",
    classification: "comparative-adjunctive-governance-evidence",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "English-he-laughed-checks-a-predicate-subject-sentence-structure",
      "English-laughed-is-the-predicate-in-he-laughed",
      "English-is-Mary-checks-a-copulative-predicate-structure",
      "English-laughed-checks-an-intransitive-predicate-structure",
      "English-makes-an-arrow-checks-a-transitive-predicate-structure",
      "English-on-the-roof-checks-a-structure-of-relation",
      "English-on-is-the-relator-in-on-the-roof",
      "English-the-roof-is-the-terminus-governed-by-on",
      "English-this-arrow-and-these-arrows-check-number-correspondence",
      "English-I-am-and-we-are-check-person-and-number-correspondence",
      "English-examples-do-not-authorize-Classical-Nahuatl-agreement-or-case-realization",
      "English-I-see-him-is-a-case-contrast-witness",
      "in-English-I-see-him-I-is-first-singular-human-subject-and-him-is-third-singular-human-object",
      "English-he-sees-me-is-a-case-contrast-witness",
      "in-English-he-sees-me-he-is-third-singular-human-subject-and-me-is-first-singular-human-object",
      "sections-17.1-42.1-49.1-and-51.1-document-later-adjunction-discussion",
    ],
    restrictions: [
      "English-examples-do-not-install-English-grammar-or-authorize-Nahuatl-results",
      "English-participant-roles-check-the-general-model-without-selecting-Nahuatl-pronouns",
      "later-section-references-do-not-execute-adjunction",
      "the-adjunctive-governance-owner-remains-separate",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "english-spanish-conjunctive-governance-evidence",
    classification: "comparative-conjunctive-governance-evidence",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "English-and-Spanish-conjunct-fillers-are-usually-members-of-the-same-form-class",
      "Lesson-52-documents-later-conjunction-discussion",
    ],
    restrictions: [
      "English-and-Spanish-form-class-tendencies-do-not-authorize-Nahuatl-conjunction",
      "Lesson-52-reference-does-not-compose-conjuncts",
      "the-conjunctive-governance-owner-remains-separate",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "english-participant-plane-confusion-evidence",
    classification: "comparative-participant-plane-evidence",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "in-Paul-broke-the-window-the-subject-Paul-has-agent-role",
      "in-the-window-got-broken-the-subject-window-has-patient-role-and-in-a-rock-broke-the-window-the-subject-rock-has-instrument-role",
      "the-criticized-form-class-account-is-an-English-fostered-conceptual-confusion",
      "using-the-criticized-account-even-for-English-is-poor-analysis",
      "applying-the-criticized-account-to-Spanish-or-Nahuatl-is-nonsensical",
    ],
    restrictions: [
      "English-examples-check-participant-role-separation-without-authorizing-Nahuatl-grammar",
      "comparative-criticism-does-not-supply-a-Nahuatl-result",
      "participant-role-and-conceptual-plane-owners-remain-separate",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "latin-discontinuity-evidence",
    classification: "discontinuity-evidence-check",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
      "latin-magna-cum-laude-means-with-high-praise",
      "latin-laude-magna-cum-glosses-are-praise-great-with",
      "latin-cum-separates-laude-from-magna-as-discontinuity-witness",
      "latin-magna-cum-laude-discontinuity-is-stylistic-not-obligatory",
      "section-4.4-routes-obligatory-discontinuity-examples",
    ],
    relations: ["latin-witness-checks-discontinuous-unit-model"],
    restrictions: [
      "latin-example-does-not-authorize-classical-discontinuity",
      "lesson-reference-is-routing-only",
      "discontinuous-unit-admissibility-owner-is-separate",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
    selection: "english-lithrotrity-example",
    classification: "nonclassical-pedagogical-vocable-example",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "evidence-only",
    facts: [
    ...
    relations: ["english-example-illustrates-vocable-as-carrier-sequence"],
    restrictions: [
  ...
  defineConceptSpec({
    domain: "structure",
    selection: "section-4.5-dyad-reference",
    classification: "dyad-example-routing-reference",
    semanticOwnerId: DOCUMENTARY_STRUCTURE_CLASSIFICATION_OWNER_ID,
    factRole: "reference-only",
    facts: ["section-4.5-supplies-a-Nahuatl-morphemic-or-morphic-dyad-example"],
    restrictions: [
      "section-reference-does-not-authorize-a-dyad",
      "inflectional-affix-dyad-analysis-owner-is-separate",
    ],
  }),
  defineConceptSpec({
    domain: "structure",
