...
export function createPreteritApiGlobals(targetObject = globalThis, installationContext = null) {
    ...
    function buildPretContextOptionsFromFlags(flags = {}, overrides = {}) {
      return buildPretUniversalContextOptions({
        ...
        hasBoundMarker: flags.hasBoundMarker,
        hasCompoundMarker: flags.hasCompoundMarker,
        hasImpersonalTlaPrefix: flags.hasImpersonalTlaPrefix,
    ...
    function buildPretVariantsOptionsFromMeta(meta, overrides = {}) {
      ...
      return {
        ...
        hasImpersonalTlaPrefix: options.hasImpersonalTlaPrefix,
...
export function installPreteritApiGlobals(targetObject = globalThis, installationContext = null) {
    const api = createPreteritApiGlobals(targetObject, installationContext);
