...
export function createVncAllomorphyModule(targetObject = globalThis, installationContext = null) {
    ...
    function getVncAllomorphyContractSurfaceForms(record = null, options = {}) {
      ...
      if (!hasResultFrame && node.classicalSurfaceSuffix) {
        forms.push(node.classicalSurfaceSuffix);
      }
    ...
    function attachVncAllomorphyGrammarContract(record = null, options = {}) {
      ...
      const orthographyFrame = options.orthographyFrame || {
        ...
        storedSurfaceStringsAuthorizeOutput: false
      };
    ...
    const LESSON20_NONACTIVE_CANVAS_REFS = Object.freeze(["Andrews Lesson 20.1", "Andrews Lesson 20.2", "Andrews Lesson 20.3", "Andrews Lesson 20.4", "Andrews Lesson 20.5", "Andrews Lesson 20.6", "Andrews Lesson 20.7", "Andrews Lesson 20.8"]);
    const LESSON20_NONACTIVE_SUFFIX_INVENTORY = Object.freeze([Object.freeze({
      suffix: "o",
      family: "plain-o"
    }), Object.freeze({
      suffix: "lo",
    ...
    const LESSON20_NONACTIVE_OVERVIEW_FRAME = Object.freeze({
      ...
      suffixFamilies: Object.freeze(["o", "lo", "hua", "ohua", "lohua", "hualo"]),
    ...
    const LESSON20_NONACTIVE_LO_FRAME = Object.freeze({
      kind: "lesson-20-lo-frame",
    ...
    const LESSON20_NONACTIVE_LO_HUA_FRAME = Object.freeze({
      kind: "lesson-20-lo-hua-frame",
      sourceSections: Object.freeze(["Andrews 20.3"]),
      andrewsSuffix: "lo-hua",
      classicalSuffix: "lohua",
    ...
    const LESSON20_NONACTIVE_O_FRAME = Object.freeze({
      kind: "lesson-20-o-frame",
      sourceSections: Object.freeze(["Andrews 20.4"]),
      andrewsSuffix: "o",
      classicalSuffix: "o",
      sourceFinals: Object.freeze(["ca", "qui", "na", "ni", "za", "ci", "cui", "ta", "ti"]),
      deletesSourceFinalVowel: true,
      baseIsReplaciveImperfective: true,
      notPerfectiveStemDespiteSurfaceIdentity: true,
      soundCorrespondences: Object.freeze([Object.freeze({
        from: "z",
        to: "x"
      }), Object.freeze({
        from: "cu",
      ...
      variantLoAllowedForSomeNaNiZa: true,
      generationAllowed: true
    });
    const LESSON20_NONACTIVE_O_HUA_FRAME = Object.freeze({
      kind: "lesson-20-o-hua-frame",
      sourceSections: Object.freeze(["Andrews 20.5"]),
      andrewsSuffix: "o-hua",
      classicalSuffix: "ohua",
      mainSource: "active intransitive source",
      sourceFinals: Object.freeze(["ca", "qui", "za", "ci", "hua", "hui", "mi", "ni", "tzi"]),
      deletesSourceFinalVowel: true,
    ...
    const LESSON20_NONACTIVE_HUA_HUA_LO_FRAME = Object.freeze({
      kind: "lesson-20-hua-hua-lo-frame",
      ...
      hualo: Object.freeze({
        ...
        classicalSuffix: "hualo",
        freeVariantOfHua: true,
        lessFrequent: true
      }),
      generationAllowed: true
    });
    const LESSON20_NONACTIVE_CLASS_FRAME = Object.freeze({
      ...
      classicalFinalOSuffixes: Object.freeze(["lo", "o", "hualo"]),
      longFinalVowelBoundary: "Andrews final o length is realized directly in Classical spelling",
    ...
    const LESSON20_NONACTIVE_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      ...
      directiveEs: "El tronco no activo se deriva de un tronco activo imperfectivo con las familias o, lo, hua, o-hua, lo-hua o hua-lo; su uso en CNV queda para Lecciones 21-22.",
      engineSurface: "nonactive source and suffix family metadata",
      implementationState: "implemented"
    }), Object.freeze({
      id: "lesson20-lo-suffix",
      andrewsSection: "20.2",
      category: "lo-suffix",
      directiveEs: "El sufijo lo se adjunta sobre todo a fuentes transitivas en a, con rutas para Clase C, raíz+ya y Clase D.",
      engineSurface: "lo nonactive option family",
      implementationState: "implemented"
    }), Object.freeze({
      id: "lesson20-lo-hua-combination",
      andrewsSection: "20.3",
      category: "lo-hua-suffix-combination",
      directiveEs: "La combinación lo-hua cubre un grupo pequeño, incluidas rutas supletivas e inserción en compuestos.",
      engineSurface: "lo-hua nonactive option family",
      implementationState: "implemented"
    }), Object.freeze({
      id: "lesson20-o-suffix",
      andrewsSection: "20.4",
      category: "o-suffix",
      directiveEs: "El sufijo o usa una base imperfectiva reemplazante con borrado de vocal final y los cambios contextuales autorizados por Andrews.",
      engineSurface: "o nonactive option family",
      implementationState: "implemented"
    }), Object.freeze({
      id: "lesson20-o-hua-combination",
      andrewsSection: "20.5",
      category: "o-hua-suffix-combination",
      directiveEs: "La combinación o-hua deriva sobre todo de fuentes intransitivas con borrado de vocal final y cambios segmentales.",
      engineSurface: "o-hua nonactive option family",
      implementationState: "implemented"
    }), Object.freeze({
      id: "lesson20-hua-suffix",
      andrewsSection: "20.6",
      category: "hua-suffix",
      directiveEs: "El sufijo hua se asocia principalmente con fuentes intransitivas en i u o, pero admite algunas transitivas.",
      engineSurface: "hua nonactive option family",
      implementationState: "implemented"
    }), Object.freeze({
      id: "lesson20-hua-lo-combination",
      andrewsSection: "20.7",
      category: "hua-lo-suffix-combination",
      directiveEs: "La combinación hua-lo funciona como variante libre menos frecuente de hua.",
      engineSurface: "hua-lo nonactive option family",
      implementationState: "implemented"
    }), Object.freeze({
    ...
    function getNonactiveSubsectionInventory() {
      return LESSON20_NONACTIVE_SUBSECTION_INVENTORY.map(entry => ({
        ...
        realizationStatus: "classical-contextual-realization-plus-source-gate-required",
    ...
    const LESSON24_FIRST_TYPE_CAUSATIVE_CANVAS_REFS = Object.freeze(["Andrews Lesson 24.1", "Andrews Lesson 24.2", "Andrews Lesson 24.3", "Andrews Lesson 24.4", "Andrews Lesson 24.5", "Andrews Lesson 24.6", "Andrews Lesson 24.7", "Andrews Lesson 24.8", "Andrews Lesson 24.9"]);
    ...
    const LESSON24_FIRST_TYPE_CAUSATIVE_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      ...
      engineSurface: "Classical wa/ua causative exceptions and source metadata",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
    ...
    function getFirstTypeCausativeSubsectionInventory() {
      return LESSON24_FIRST_TYPE_CAUSATIVE_SUBSECTION_INVENTORY.map(entry => ({
        ...entry,
        canvasRef: `Andrews Lesson ${entry.andrewsSection}`,
        evidenceStatus: "direct-canvas-partial",
        orthographyStatus: "classical-boundary-plus-source-gate-required",
    ...
    const LESSON25_SECOND_TYPE_CAUSATIVE_CANVAS_REFS = Object.freeze(["Andrews Lesson 25.1", "Andrews Lesson 25.2", "Andrews Lesson 25.3", "Andrews Lesson 25.4", "Andrews Lesson 25.5", "Andrews Lesson 25.6", "Andrews Lesson 25.7", "Andrews Lesson 25.8", "Andrews Lesson 25.9", "Andrews Lesson 25.10", "Andrews Lesson 25.11", "Andrews Lesson 25.12", "Andrews Lesson 25.13", "Andrews Lesson 25.14", "Andrews Lesson 25.15", "Andrews Lesson 25.16"]);
    ...
    function getSecondTypeCausativeSubsectionInventory() {
    ...
    function getApplicativeSubsectionInventory() {
    ...
    function buildVncAllomorphySoundSpellingFrame(frameInput = {}, beforeValue = "", afterValue = "", role = "") {
      if (
        frameInput.ruleId !== "supportive-i-stem-initial-elision"
        || typeof targetObject.buildClassicalNahuatlVowelElisionFrame !== "function"
      ) {
        return null;
      }
      const frame = targetObject.buildClassicalNahuatlVowelElisionFrame({
        ruleId: "cn-l2-214-supportive-i-not-proper-elision",
        supportiveI: true,
        vowelLength: "short",
      ...
      return {
        ...
        analysisKind: frame.canonicalAnalysisKind,
        sourceSurface: String(frameInput.source || ""),
        target: String(frameInput.target || ""),
        grammarSlot: String(frameInput.slot || ""),
        syllablePosition: String(frameInput.syllablePosition || ""),
    ...
    function pushVncAllomorphyLesson2SoundSpellingFrame(frames = [], frameInput = {}, beforeValue = "", afterValue = "", role = "") {
      ...
      const frame = buildVncAllomorphySoundSpellingFrame(frameInput, beforeValue, afterValue, role);
      if (!frame) {
        return;
      }
    ...
    function deriveNonspecificObjectAllomorphyTargetFromSourceFrame(sourceFrame = null) {
      ...
      const shouldElideReflexiveO = obj1 === "mo" && (targetObject.startsWithICVCVPattern(base) || targetObject.startsWithAlPrefix(base) || targetObject.startsWithACVlPattern(base)) && !targetObject.startsWithAny(base, targetObject.NONSPECIFIC_I_DROP_VERBS);
      if (shouldElideReflexiveO) {
        ...
        pushVncAllomorphyLesson2SoundSpellingFrame(soundSpellingFrames, {
          ruleId: "cn-l6-reflexive-o-elision-before-vowel",
          source: obj1,
          target: "m",
          slot: "obj1",
    ...
    function buildSerialStemDashSourceFrame(baseValue = "") {
      ...
      const route = collapseByPattern(/^([a-z]+)-ti$/i, "serial-ti-stem-dash-collapse", "ti", ["ti"]) || collapseByPattern(/^([a-z]+)-ya$/i, "serial-ya-stem-dash-collapse", "ya", ["ya"]) || collapseByPattern(/^([a-z]+)-u-a$/i, "serial-ua-stem-dash-collapse", "ua", ["o", "a"]) || collapseByPattern(/^([a-z]+)-a-wi$/i, "serial-awi-stem-dash-collapse", "awi", ["a", "wi"]) || collapseByPattern(/^([a-z]+)-i-wi$/i, "serial-iwi-stem-dash-collapse", "iwi", ["i", "wi"]);
      if (!route) {
        return null;
      }
    ...
    function buildIntransitiveTypeOneOperationFrame(sourceFrame = null) {
      ...
      } else if (target === "hua" && rightEdgeClass === "hua") {
        targetStem = sourceStem;
      } else if (target === "hua" && rightEdgeClass === "wi") {
        targetStem = `${sourceStem.slice(0, -1)}a`;
      } else if (target === "ua" && ["awa", "iwa", "ewa", "ohua", "awi", "iwi", "uwi"].includes(rightEdgeClass)) {
    ...
    function getActiveActionNominalizerContract() {
      const contract = {
        ...
        boundaries: Object.freeze({
          classicalSurfaceOnly: true,
          noFixtureEvidence: true,
          preservesGeneratedSurfaceForms: true,
          orthographyConversionAllowed: false
        })
      };
      return Object.freeze(attachVncAllomorphyGrammarContract(contract, {
        ...
        orthographyFrame: {
          ...
          surfaceForms: [contract.surfaceSuffixes.short, contract.surfaceSuffixes.long].filter(Boolean),
          spellingAuthority: "Classical Andrews transcription",
          classicalSurfaceOnly: true,
          orthographyConversionAllowed: false
        },
    ...
    function getActiveActionNominalizerSuffixes() {
      ...
      return Object.freeze([contract.classicalSuffixes.long, contract.classicalSuffixes.short].filter(Boolean));
    }
    ...
    function getPatientivoNonactiveSourceSuffixContract(sourceSuffix = "") {
      ...
      const contractRecord = {
        ...
        classicalRuleSuffix: contract.classicalSuffix,
        classicalSurfaceSuffix: String(contract.classicalSuffix).replace(/[^a-z]/g, ""),
      ...
      return Object.freeze(attachVncAllomorphyGrammarContract(contractRecord, {
        ...
        orthographyFrame: {
          ...
          surface: contractRecord.classicalSurfaceSuffix,
          surfaceForms: contractRecord.classicalSurfaceSuffix ? [contractRecord.classicalSurfaceSuffix] : [],
        ...
        targetContract: {
          ...
          classicalConnectorFamily: contractRecord.classicalConnectorFamily
        }
      }));
    }
    ...
    function getCausativeDerivationOptions(verb, analysisVerb, options = {}) {
      ...
      const classifyIntransitiveICausativeByMatrix = () => {
        ...
        if (hasEndingFamily("m+i")) {
          if (causativePattern.has({
            ...
            if (["o", "i", "e"].includes(penultimateNucleus)) {
              return {
                label: "replacive",
      ...
      if (allowIntransitiveTypeOnePolicy && (!blockTypeOneCausativeForI || isDirectIntransitiveTypeOnePolicySource)) {
        const pushIntransitiveTypeOnePolicyTarget = typeOneTarget => {
          const sourceSuffix = hasEndingFamily("w+i") ? "wi" : hasEndingFamily("w+a") ? "hua" : hasEndingFamily("n+i") ? "ni" : "";
      ...
      if (allowTypeTwo && !blockTypeTwoForDescriptor) {
        ...
        const shortStemDeleteSuffixes = new Set(Array.from(deleteSuffixes).filter(suffix => suffix !== "hua"));
        ...
        if (nonRedupRuleBase && nonRedupRuleBase !== ruleBase) {
          ...
          addSynthesized("hua", () => buildAppendMorphStemSpec(ruleBase, "hua", {
            sourceBase: ruleBase,
            sourceSuffix: "hua"
          }));
          addSynthesized("o", () => buildNonactiveUStemMorphStemSpec(ruleBase, finalOnset, finalNucleus, {
            sourceBase: ruleBase,
            sourceSuffix: "o",
            blockCh: blockChForTi,
            blockOnsetReplacement
          }));
          addSynthesized("ohua", () => buildNonactiveUwaStemMorphStemSpec(ruleBase, finalOnset, finalNucleus, {
            sourceBase: ruleBase,
            sourceSuffix: "ohua",
            blockCh: blockChForTi,
            blockOnsetReplacement
          }));
          addSynthesized("lo", () => buildAppendMorphStemSpec(ruleBase, "lo", {
            sourceBase: ruleBase,
            sourceSuffix: "lo"
          }));
        }
        const hasTransitiveCodaS = isTransitive && hasEndingFamily("s+i");
        if (hasTransitiveCodaS && !hasOptionFamily(typeTwoOptions, "ohua")) {
        ...
        if (isTransitive && hasEndingFamily("w+i") && allowedSuffixes.includes("o") && !hasOptionFamily(typeTwoOptions, "o")) {
        ...
        if (allowTransitiveChiwaUBase && allowedSuffixes.includes("o") && !hasOptionFamily(typeTwoOptions, "o")) {
          const uStemSpec = buildNonactiveUStemMorphStemSpec(ruleBase, finalOnset, finalNucleus, {
            sourceBase: ruleBase,
            sourceSuffix: "o",
            blockCh: previousHasCoda || hasEndingFamily("t+i") && preFinalIsConsonant,
        ...
        const allowIntransitiveMonosyllableUwaTypeTwo = isIntransitiveMonosyllable && hasOptionFamily(typeTwoOptions, "ohua");
        const shouldUseSupportiveITypeTwo = (optionSuffix, baseStem, currentSuffix) => {
          if (currentSuffix !== typeTwoSuffix) {
            return false;
          }
          if (allowIntransitiveMonosyllableUwaTypeTwo && optionSuffix === "ohua") {
            return true;
          }
          if (!["o", "ohua"].includes(optionSuffix)) {
            return false;
          }
          const clusterStem = getClusterBaseStem(baseStem);
          return endsWithCluster(clusterStem);
        };
        const preferIntransitiveBisyllableUwa = isIntransitive && sourceSyllableCount === 2 && !blockUwaTypeTwo && allowedSuffixes.includes("ohua") && hasOptionFamily(typeTwoOptions, "ohua");
        const preferTransitiveCodaSUwaBase = hasTransitiveCodaS && hasOptionFamily(typeTwoOptions, "ohua");
        ...
        if (isIntransitive && finalNucleus === "o" && hasNonactiveFamily("hua")) {
          ...
          if (useReplacement) {
            pushWithRoute(buildReplaceSuffixMorphStemSpec(ruleBase, "o", "awia"), "", "", {
              type: "type-two",
        ...
        typeTwoOptions.forEach(option => {
          ...
          if (forceTiBecomeTypeTwo && !optionHasFamily(option, "lo")) {
            return;
          }
          if (isIntransitiveMonosyllable && shortStemDeleteSuffixes.has(optionFamily) && !(allowIntransitiveMonosyllableUwaTypeTwo && optionHasFamily(option, "ohua"))) {
            // For short stems, only paths that remove base material (u/uwa) are blocked.
            return;
          }
          if (isRootPlusYa && optionHasFamily(option, "lo") && optionStem === `${ruleBase}lu`) {
            return;
          }
          if (optionHasFamily(option, "hua") && uwaClusterBase) {
            return;
          }
          if (isIntransitive && hasEndingFamily("w+i")) {
            ...
            if (wiCluster && optionHasFamily(option, "ohua")) {
              return;
            }
            if (!wiCluster && wiSyllableCount >= 3 && optionHasFamily(option, "ohua")) {
              return;
            }
            if (!wiCluster && wiSyllableCount === 2 && optionHasFamily(option, "hua")) {
              return;
            }
          }
          if (forceUwaOnly && optionHasFamily(option, "hua")) {
            return;
          }
          if (blockUwaTypeTwo && optionHasFamily(option, "ohua")) {
            return;
          }
          if (isIntransitive && optionHasFamily(option, "hua") && finalOnset === "k" && hasNonactiveFamily("ohua")) {
          ...
          if (isIntransitive && optionHasFamily(option, "lo") && finalOnset === "s" && hasNonactiveFamily("ohua")) {
          ...
          if (blockExpandedTiCausatives && optionHasFamily(option, "lo") && !forceTiBecomeTypeTwo) {
            return;
          }
          if (blockExpandedTiCausatives && optionHasFamily(option, "ohua") && !allowTiUwaChtia) {
            return;
          }
          if (isIntransitive && hasEndingFamily("t+i") && optionHasFamily(option, "hua") && !forceTiHaveTypeTwo) {
            // Intransitive stems ending in -ti do not form type-two causatives from the -wa nonactive base.
            return;
          }
          if (isIntransitive && hasEndingFamily("t+i") && isSlashMatrixTiInput && !allowIntransitiveTiChtia && optionHasFamily(option, "ohua")) {
          ...
          if (isIntransitive && finalNucleus === "o" && optionHasFamily(option, "hua")) {
          ...
          if (optionHasFamily(option, "lo")) {
            baseStem = optionStem.endsWith("lo") ? optionStem.slice(0, -1) : optionStem;
          } else if (deleteSuffixes.has(optionFamily)) {
            if (optionHasFamily(option, "hua") && optionStem.endsWith("hua")) {
              baseStem = optionStem.slice(0, -2);
            } else if (optionHasFamily(option, "o") && optionStem.endsWith("o")) {
              baseStem = optionStem.slice(0, -1);
            } else if (optionHasFamily(option, "ohua") && optionStem.endsWith("ohua")) {
              baseStem = optionStem.slice(0, -3);
            }
          }
          if (optionHasFamily(option, "ohua") && hasEndingFamily("n+i") && baseStem.endsWith("o")) {
            baseStem = baseStem.slice(0, -1);
          }
          let suffix = typeTwoSuffix;
          if (finalNucleus === "o" && optionHasFamily(option, "hua")) {
            suffix = "wia";
          }
          if (isIntransitive && optionHasFamily(option, "lo") && hasEndingFamily("t+i")) {
            suffix = "ia";
          }
          if (shouldUseSupportiveITypeTwo(optionFamily, baseStem, suffix)) {
            suffix = `i${suffix}`;
          }
          if (optionHasFamily(option, "ohua") && suffix.endsWith(typeTwoSuffix) && finalOnset === "w") {
            suffix = `w${suffix}`;
          }
          if (optionHasFamily(option, "lo") && isRootPlusYa && rootPlusYaBase) {
          ...
          if (optionHasFamily(option, "lo") && rootPlusYaBase && (rootPlusYaBase.endsWith("ti") || rootPlusYaBase.endsWith("wi"))) {
            pushWithRoute(buildReplaceSuffixMorphStemSpec(`${rootPlusYaBase}ya`, "ya", "lia"), "", "", {
              type: "type-two",
          ...
          if (baseStem) {
            ...
            const preferUwaSh = optionHasFamily(option, "ohua") && finalOnset === "s" && optionStem.includes("sh");
            const preferUwaFromTransitiveCodaS = optionHasFamily(option, "ohua") && preferTransitiveCodaSUwaBase;
            const preferIntransitiveBisyllableUwaBase = preferIntransitiveBisyllableUwa && optionHasFamily(option, "ohua");
            const preferIntransitiveMonosyllableUwa = allowIntransitiveMonosyllableUwaTypeTwo && optionHasFamily(option, "ohua");
            const preferTransitiveWiU = optionHasFamily(option, "o") && preferTransitiveWiUBase;
    ...
    function computeAllowTypeTwoCausativeForParsedVerb(parsedVerb) {
      ...
      if (ruleBaseForGate) {
        ...
        if (!parsedVerb.isMarkedTransitive && gateDescriptor.finalNucleus === "o" && typeTwoGate.endsWithU !== false) {
        ...
        if (!parsedVerb.isMarkedTransitive && gatePattern.has({
          ...
          const requiredSuffix = typeof niGate.requireNonactiveSuffix === "string" ? niGate.requireNonactiveSuffix : "ohua";
        ...
        if (!parsedVerb.isMarkedTransitive) {
          ...
          if (gateSyllableCount <= 1) {
            allowTypeTwoIntransitiveLu = gateHasNonactiveFamily("lo");
          }
          if (gatePattern.has({
            endingFamily: "k+i",
    ...
    function getApplicativeDerivationOptions(verb, analysisVerb, options = {}) {
      ...
      if (isTransitive && (applicativePattern.has({
        ...
        let stockFormative = matchesUaStock ? "o" : inferWiStockFormative(baseStem);
      ...
      let luOptions = nonactiveOptions.filter(option => optionHasFamily(option, "lo") && realizeMorphStemSpec(option?.stemSpec, option?.stem || ""));
      const uwaOptions = nonactiveOptions.filter(option => optionHasFamily(option, "ohua") && realizeMorphStemSpec(option?.stemSpec, option?.stem || ""));
      if (isRootPlusYa) {
      ...
      if (allowIntransitiveShortUwaApplicative && uwaOptions.length) {
        uwaOptions.forEach(option => {
          ...
          if (baseStem) {
            const sourceBase = optionStem.endsWith("ohua") ? optionStem.slice(0, -3) : "";
      ...
      luOptions.forEach(option => {
        ...
        const sourceBase = optionStem.endsWith("lo") ? optionStem.slice(0, -2) : "";
    ...
    function getBaseObjectSlots(verbMeta) {
      ...
      if (totalSlots && totalSlots > 0) {
        ...
        if (verbMeta.isMarkedTransitive || verbMeta.isTlaFusion) {
          baseSlots = 1;
        } else {
    ...
    function getNonactiveBaseInfo(ruleBase) {
      ...
      const endsWithNucleusU = lastNucleus === "o";
    ...
    function getDerivationNonactiveDeleteBehavior(nonactiveFamily = "") {
      if (nonactiveFamily === "lo") {
        return "drop-final-u";
      }
      if (["hua", "o", "ohua"].includes(nonactiveFamily)) {
    ...
    function getNonactiveCandidateParts(info) {
      ...
      const blockUwaForPenultimateU = lastOnset === "w" && (endsWithNucleusA || endsWithNucleusI) && penultimateNucleus === "o";
    ...
    function buildNonactiveStemSelectionSourceFrame({
      ...
      return Object.freeze({
        ...
        sourceSignature: [sourceStem, analysisStem, ruleBase, options?.isTransitive === true ? "transitive" : "intransitive", normalizeDerivationStemValue(options?.rootPlusYaBase || "")].join("|"),
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false
      });
    }
    ...
    function derivePatientivoStemFromNonactiveEntries(sourceFrame = null) {
      ...
      const buildUVariants = (base, variantOptions = {}) => {
        const isTransitive = options.isTransitive === true;
        const recoversDeletedW = normalizedSuffix === "ohua" && baseInfo && baseInfo.lastOnset === "w";
    ...
    function buildPatientivoSourceModel(options = {}, sourceType = PATIENTIVO_DERIVATION_SOURCE_TYPE.nonactive) {
      ...
      return Object.freeze({
        ...
        hasImpersonalTlaPrefix: options?.hasImpersonalTlaPrefix === true
      });
    }
    ...
    function buildPatientivoDerivations({
      ...
      options.forEach(option => {
        ...
        derivedList.forEach(derived => {
          ...
          if (option.suffix === "ohua" && (derivedSurface.endsWith("it") || derivedSurface.endsWith("iti"))) {
            return;
          }
    ...
    function getPatientivoPerfectiveSourceStemContract(stem = "") {
      ...
      if (!contract) {
        const blockedContract = {
          ...
          classicalEndings: Object.freeze([]),
      ...
      const supportedContract = {
        ...
        classicalEndings: Object.freeze([...(contract.classicalEndings || [])]),
    ...
    function buildSustantivoVerbalStemCandidates({
      ...
      const droppedYaLooksLikeRootPlusYa = Boolean(droppedSourceYaBasePronounceable && (droppedSourceYaBasePronounceable.endsWith("i") || droppedSourceYaBasePronounceable.endsWith("o") || droppedSourceYaBasePronounceable.endsWith("ya") || targetObject.endsWithAny(droppedSourceYaBasePronounceable, targetObject.IA_UA_SUFFIXES) || Boolean(rootPlusYaBase) || Boolean(rootPlusYaBasePronounceable)));
    ...
    function buildPatientivoRootStockSourceContractRecord(options = {}) {
      ...
      const contract = {
        ...
        andrewsNounstemClass: "tli",
        classicalConnectorFamily: "t/ti",
        connectorRule: "tli-class-surface-connector-follows-current-Classical-stem-shape",
    ...
    function buildPatientivoRootStockStemSourceFrame({
      ...
      const rightEdgeFrame = Object.freeze({
        ...
        replacementSegment: routeOperation === "productive-ya-l-root-stock-stem" ? "l" : routeOperation === "iwi-final-cluster-root-stock-stem" ? "i" : routeOperation === "awi-final-cluster-root-stock-stem" ? "a" : routeOperation === "ua-final-cluster-root-stock-stem" ? "o" : "",
    ...
    function getPatientivoImperfectiveSourceStemContract({
      ...
      const contract = {
        ...
        andrewsNounstemClass: "ti",
        classicalConnectorFamily: "t/ti",
        connectorRule: "ti-class-surface-connector-follows-current-Classical-stem-shape",
    ...
    function buildPatientivoTroncoDerivations({
      ...
      if (isIwiAwiUa && gateIsIwiAwiUa && gateIwiAwiUaSuffix === iwiAwiUaSuffix && (hasMultisyllableCoreBeforeSuffix(iwiAwiUaSuffix, gateBase) || allowShortIwiCore || allowMonosyllableIwiAwiUa)) {
        ...
        if (familyCore) {
          if (hasFinalConsonantCluster(familyCore)) {
            const recoveredVowel = iwiAwiUaSuffix === "iwi" ? "i" : iwiAwiUaSuffix === "awi" ? "a" : "o";
      ...
      if (!isIwiAwiUa && (endsWithPlainWi || endsWithPlainWa)) {
        const wiWaSuffix = endsWithPlainWi ? "wi" : "hua";
        const gateWiWaSuffix = gateEndsWithPlainWi ? "wi" : gateEndsWithPlainWa ? "hua" : "";
    ...
    function getNonactiveDerivationOptions(verb, analysisVerb, options = {}) {
      ...
      const buildLu = () => {
        ...
        return buildAppendMorphStemSpec(base, "lo", {
          sourceBase: base,
          sourceSuffix: "lo"
        });
      };
      ...
      const buildPlainUT = () => buildReplaceSuffixMorphStemSpec(source, source.slice(-1), "o");
      const buildWa = () => buildAppendMorphStemSpec(source, "hua", {
        sourceBase: source,
        sourceSuffix: "hua"
      });
      ...
      if (isClassC) {
        ...
        const stemSpec = buildAppendMorphStemSpec(base, "lo", {
          sourceBase: base,
          sourceSuffix: "lo"
        });
        return [{
      ...
      if (luCandidate) {
        ...
        if (endsWithYa && !isTransitive) {
          const yaLu = buildAppendMorphStemSpec(source, "lo", {
            sourceBase: source,
            sourceSuffix: "lo"
          });
        ...
        if (isTransitive && endsWithTV) {
          const altLu = buildAppendMorphStemSpec(source, "lo", {
            sourceBase: source,
            sourceSuffix: "lo"
          });
          if (realizeMorphStemSpec(altLu) !== realizeMorphStemSpec(baseLu)) {
      ...
      if (uCandidate) {
        const uStem = buildU();
        pushWithVariants("o", uStem);
      }
      if (allowPlainUVariant) {
        pushWithVariants("o", buildPlainUT());
      }
      if (waCandidate) {
        ...
        if (onsetVariantStem && onsetVariantStem !== baseWaStem) {
          push("hua", onsetVariantSpec);
        }
      }
      if (uwaCandidate) {
        pushWithVariants("ohua", buildUwa());
      }
      ...
      if (allowLuVariant) {
        push("lo", buildLu());
        if (isTransitive && endsWithTV) {
          push("lo", buildAppendMorphStemSpec(source, "lo", {
            sourceBase: source,
            sourceSuffix: "lo"
          }));
        }
      ...
      if (isTransitive && isTiNonactive && !allowChiwaOrShiwa) {
        ...
        push("lo", buildAppendMorphStemSpec(chuStem, "lo", {
          sourceBase: chuStem,
          sourceSuffix: "lo"
        }));
      }
      if (allowWaluVariant) {
        push("hualo", buildAppendMorphStemSpec(source, "hualo", {
          sourceBase: source,
          sourceSuffix: "hualo"
        }));
      }
    ...
    Object.defineProperty(api, "LESSON20_NONACTIVE_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON20_NONACTIVE_CANVAS_REFS; },
    });
    Object.defineProperty(api, "LESSON20_NONACTIVE_SUFFIX_INVENTORY", {
        configurable: true,
        enumerable: true,
        get() { return LESSON20_NONACTIVE_SUFFIX_INVENTORY; },
    });
    ...
    Object.defineProperty(api, "LESSON20_NONACTIVE_LO_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON20_NONACTIVE_LO_FRAME; },
    });
    Object.defineProperty(api, "LESSON20_NONACTIVE_LO_HUA_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON20_NONACTIVE_LO_HUA_FRAME; },
    });
    Object.defineProperty(api, "LESSON20_NONACTIVE_O_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON20_NONACTIVE_O_FRAME; },
    });
    Object.defineProperty(api, "LESSON20_NONACTIVE_O_HUA_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON20_NONACTIVE_O_HUA_FRAME; },
    });
    Object.defineProperty(api, "LESSON20_NONACTIVE_HUA_HUA_LO_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON20_NONACTIVE_HUA_HUA_LO_FRAME; },
    });
    ...
    api.getNonactiveSubsectionInventory = getNonactiveSubsectionInventory;
    ...
    Object.defineProperty(api, "LESSON24_FIRST_TYPE_CAUSATIVE_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON24_FIRST_TYPE_CAUSATIVE_CANVAS_REFS; },
    });
    ...
    api.getFirstTypeCausativeSubsectionInventory = getFirstTypeCausativeSubsectionInventory;
    ...
    Object.defineProperty(api, "LESSON25_SECOND_TYPE_CAUSATIVE_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON25_SECOND_TYPE_CAUSATIVE_CANVAS_REFS; },
    });
    ...
    api.getSecondTypeCausativeSubsectionInventory = getSecondTypeCausativeSubsectionInventory;
    Object.defineProperty(api, "LESSON26_APPLICATIVE_VALIDATION_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON26_APPLICATIVE_VALIDATION_REFS; },
    });
    Object.defineProperty(api, "LESSON26_APPLICATIVE_CANVAS_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON26_APPLICATIVE_CANVAS_REFS; },
    });
    ...
    api.getApplicativeSubsectionInventory = getApplicativeSubsectionInventory;
    api.replaceAnalysisSuffix = replaceAnalysisSuffix;
    api.buildVncAllomorphySoundSpellingFrame = buildVncAllomorphySoundSpellingFrame;
...
export function installAllomorphyGlobals(targetObject = globalThis, installationContext = null) {
    const api = createVncAllomorphyModule(targetObject, installationContext);
