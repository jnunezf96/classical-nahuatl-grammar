...
export const CLASSICAL_NAHUATL_LESSONS20_22_CLOSURE_CLAIMS = Object.freeze([
  ...
  C({ id: "l22-221-meteorological-inventory", lesson: 22, section: "22.1", lineStart: 7238, lineEnd: 7246, category: "lexical-evidence", path: "getClassicalNahuatlInherentImpersonalSourceAnalysis", proofFamily: "evidence", summary: "The listed meteorological stems are known lexical examples and defaults, not an authorization list; their printed finite forms are evidence, not answer authority." }),
  ...
  C({ id: "l22-226-meteorological-extensions", lesson: 22, section: "22.6", lineStart: 7411, lineEnd: 7421, category: "lexical-inventory", path: "getClassicalNahuatlTlaImpersonalSourceAnalysis", proofFamily: "tla", summary: "The listed lightning, thunder, darkness, dawn, and cold-weather stems document known tla-impersonal readings without forming a whitelist." }),
...
export function getClassicalNahuatlInherentImpersonalSourceAnalysis(sourceStem = "") {
  ...
  return Object.freeze({
    ...
    sourceAnalysisStatus: resolved ? "canvas-known-lexical-default" : "user-supplied-typed-lexical-analysis",
...
export function getClassicalNahuatlTlaImpersonalSourceAnalysis(sourceStem = "") {
  ...
  return Object.freeze({
    ...
    enteredSourceStem: normalized,
    canonicalSourceStem: resolved?.sourceStem || normalized,
    targetStem: resolved?.record.targetStem || (normalized ? `tla-${normalized}` : ""),
    semanticClass: resolved?.record.semanticClass || "open-productive-source",
    sourceAnalysisStatus: resolved ? "canvas-known-default-or-exception" : "open-productive-source",
    canvasExampleMatch: Boolean(resolved),
    sourceDocument: SOURCE_DOCUMENT,
    transcriptionLineStart: resolved?.record.lineStart || 0,
    transcriptionLineEnd: resolved?.record.lineEnd || 0,
    targetDerivedByEngine: Boolean(normalized),
