...
export const CLASSICAL_NAHUATL_LESSONS12_15_CLOSURE_CLAIMS = Object.freeze([
  ...
  C({ id: "l15-1514-possessor-reduplication", lesson: 15, section: "15.1.4", lineStart: 5219, lineEnd: 5221, category: "structural-choice", path: "buildClassicalNahuatlPossessorReduplicationSelection", proofFamily: "possessor", summary: "The user may reduplicate the dyadic possessor in the required possessive-plural structure." }),
