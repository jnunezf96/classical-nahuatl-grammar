...
const PARTICLES = Object.freeze({
    ...
    "l3-in-aya": ["in + ah# + ye", "in aya", ["before"]],
    ...
    "l3-ahza-zo": ["ah# + zā + zo", "ahzā zo", ["perhaps", "maybe"]],
    "l3-ahza-zo-oc": ["ah# + zā + zo + oc", "ahzā zo oc", ["perhaps still", "perhaps another"]],
    ...
    "l3-ahzo-za": ["ah# + zo + zā", "ahzo zā", ["perhaps", "maybe", "possibly"]],
    "l3-ahzo-zan": ["ah# + zo + zan", "ahzo zan", ["perhaps", "maybe", "possibly"]],
    "l3-ahzo-ah": ["ah# + zo + ah#", "ahzo ah", ["perhaps not"]],
    "l3-ahzo-ma": ["ah# + zo + mā", "ahzo mā", ["perhaps"]],
    ...
    "l3-ahca-zo": ["ah# + ca + zo", "ahca zo", ["perhaps", "maybe"]],
    "l3-ahzo-ca": ["ah# + zo + ca", "ahzo ca", ["perhaps", "maybe"]],
...
function run(ctx = {}) {
    ...
    const ruleObservations = new Map([
        ...
        ["ACI-P057-L023-C7FBC7F91A-02", [...negativeSelection("l3-ma", "wish"), ...negativeSelection("l3-tla", "command")]],
    ...
    const expectedRules = new Map([
        ...
        ["ACI-P057-L023-C7FBC7F91A-02", ["authorized", "l3-ca-negative", "ca#", "ca-after-ma-or-tla-in-wish-or-command", false, "authorized", "l3-ca-negative", "ca#", "ca-after-ma-or-tla-in-wish-or-command", false]],
        ["ACI-P057-L023-C7FBC7F91A-03", ["authorized", "l3-ca-negative", "ca#", "ca-after-mah", false]],
