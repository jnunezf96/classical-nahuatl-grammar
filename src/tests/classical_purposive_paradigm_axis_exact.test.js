...
function run(ctx = {}) {
    ...
    const observations = [
        ...
        ["ACI-P267-L030-5D96BD40A2-08", "cases.paradigmAxisExamples.singFirstPlural.canonicalTranscriptionFormula", "#ti-Ø(cuīca-⎕-t-ī-hui)Ø+Ø-h#"],
        ...
        ["ACI-P268-L007-3A37BD42BF-08", "cases.paradigmAxisExamples.eatSecondPlural.canonicalTranscriptionFormula", "#an-Ø+tla(cuā-⎕-t-ī-hui)Ø+Ø-h#"],
