...
function run() {
    ...
    suite.ok(
        "the ledger observes one continuous Source to Grammar to Result path and its exact handoffs",
        ledgerModule.includes("function describeCompositionPath(")
            && ledgerModule.includes('kind: "classical-source-grammar-result-composition-path"')
            && ledgerModule.includes('fallbackRole: "present-typed-facts"')
            && ledgerModule.includes('fallbackRole: "genuine-open-choices"')
            && ledgerModule.includes('fallbackRole: "owner-issued-fullness"')
            && ledgerModule.includes("sourceToGrammar:")
            && ledgerModule.includes("grammarToResult:")
            && ledgerModule.includes("resultToSource:")
            && ledgerModule.includes("resultToClauseComposition:")
            && ledgerModule.includes("exactOwnerIssuedResultRequired: true")
            && ledgerModule.includes("exactCapturedResultsRequired: true")
            && ledgerModule.includes("compositionPath: describeCompositionPath(")
            && ledgerModule.includes("grammarAuthority: false")
    );
    suite.ok(
        "the ledger records the delivered live path summary without granting it authority",
        ledgerModule.includes("deliveredSummaryValues")
            && ledgerModule.includes("deliveredSummaryDetails")
            && ledgerModule.includes("deliveredSummaryStepStates")
            && ledgerModule.includes("deliveredLayers")
            && ledgerModule.includes("deliveredNextOperations")
            && ["source", "grammar", "result", "continue"].every(step => (
                ledgerModule.includes(`"${step}"`)
            ))
            && ledgerModule.includes("deliveredSummary: {")
            && ledgerModule.includes("classicalCompositionPathSummarySourceUnit")
            && ledgerModule.includes("classicalCompositionPathSummaryGrammarOperation")
            && ledgerModule.includes("classicalCompositionPathSummaryLayerGraph")
            && ledgerModule.includes("classicalCompositionPathSummaryLayerCount")
            && ledgerModule.includes("classicalCompositionPathSummaryLayerEdgeCount")
            && ledgerModule.includes("classicalCompositionPathSummaryLayerTopology")
            && ledgerModule.includes("classicalCompositionPathSummaryLayerOperations")
            && ledgerModule.includes("classicalCompositionPathSummaryNextOperationCount")
            && ledgerModule.includes("classicalCompositionPathSummaryResultUnit")
            && ledgerModule.includes("classicalCompositionPathSummaryResultStatus")
            && ledgerModule.includes("classicalCompositionPathSummaryResultProjection")
            && ledgerModule.includes("choicePath: {")
            && ledgerModule.includes("classicalChoicePathPanel")
            && ledgerModule.includes("classicalChoicePathOrder")
            && ledgerModule.includes("classicalChoicePathState")
            && ledgerModule.includes("classicalChoicePathNext")
            && ledgerModule.includes("classicalChoiceOptionCount")
            && ledgerModule.includes("classicalChoicePathKind")
            && ledgerModule.includes("classicalChoicePathAuthority")
            && ledgerModule.includes("interfaceClassification: {")
            && ledgerModule.includes("classicalInterfaceControlRole")
            && ledgerModule.includes("classifiedVisibleControls")
            && ledgerModule.includes("pathChoiceControls")
            && ledgerModule.includes("transitionActionControls")
            && ledgerModule.includes("supportActionControls")
            && ledgerModule.includes("readingCueControls")
            && ledgerModule.includes("unclassifiedVisibleControls")
            && ledgerModule.includes("interfaceControlExhaustion: {")
            && ledgerModule.includes('scope: "current-live-branch"')
            && ledgerModule.includes("terminalRouteComplete")
            && ledgerModule.includes("unclassifiedControls")
            && ledgerModule.includes("routeIssues: {")
            && ledgerModule.includes("classicalCompositionPathSummaryContinuationStatus")
            && ledgerModule.includes("classicalCompositionPathLiveState")
            && ledgerModule.includes("stepStates: deliveredSummaryStepStates")
            && ledgerModule.includes("details: deliveredSummaryDetails")
            && ledgerModule.includes('role: "delivered-path-observation-only"')
    );
    suite.ok(
