...
function buildMatiPassiveSource(ctx, tense = "present") {
    const active = ctx.buildClassicalNahuatlVerbstemClassFrame("mati", {
        subject: "3sg",
        mood: "indicative",
        tense,
        verbClass: "B",
    ...
    const nonactive = ctx.deriveClassicalNahuatlNonactiveStemRecord("mati", {
        verbClass: "B",
...
function run(ctx = {}) {
        ...
        [
            {
                ...
                positions: [
                    ...
                    ["causative-object", "mainline", "tē", true],
                ],
            },
            {
                realization: "sounded",
    ...
    s.eq(
        ...
        {
            canonical: true,
            formula: "#0-0+qui-0+tē(mach-tiā)ya+0-0#",
            semanticIdentity: "0|0|qui-0|tē|mach-tiā|ya|0|0",
        }
    );
    ...
    s.eq(
        ...
        (() => {
            ...
            const cluster = ctx.buildClassicalNahuatlObjectClusterFrame("maca", {
                subject: "3sg",
            ...
            return {
                canonical: [
                    ...
                    ctx.isClassicalNahuatlObjectClusterFrame(cluster, "maca"),
                ...
                forgedValidators: [
                    ...
                    forgedLinearOrder,
                    forgedOrderingRule,
                ].map(frame => ctx.isClassicalNahuatlObjectClusterFrame(frame, "maca")),
