import { installClassicalNahuatlVncApplicationGlobals } from "../application/classical/vnc_application.mjs?v=20260822-all-operation-layers-216";
import { installClassicalNahuatlNncApplicationGlobals } from "../application/classical/nnc_application.mjs?v=20260822-all-operation-layers-216";
import { installClassicalGrammarApplicationGlobals } from "../application/classical/grammar_application.mjs?v=20260822-all-operation-layers-216";
...
import { installClassicalNahuatlNncLayerEvaluatorGlobals } from "../core/classical/nnc_layer_evaluator.mjs?v=20260822-all-operation-layers-216";
import { installClassicalNahuatlNominalConstructionGlobals } from "../core/classical/nominal_construction.mjs?v=20260822-all-operation-layers-216";
import { installClassicalNahuatlDeverbalNncGlobals } from "../core/classical/nnc_lessons35_39_closure.mjs?v=20260822-all-operation-layers-216";
...
import { installClassicalNahuatlAdverbialNuclearGlobals } from "../core/classical/adverbial_nuclear_grammar.mjs?v=20260822-all-operation-layers-216";
...
import { installClassicalNahuatlVncLayerEvaluatorGlobals } from "../core/classical/vnc_layer_evaluator.mjs?v=20260818-lesson29-groups10-12-357";
import { installClassicalNahuatlVncClosureGlobals } from "../core/classical/vnc_lessons27_29_33_closure.mjs?v=20260822-all-operation-layers-216";
...
import { installClassicalNuclearSemanticOwnersGlobals } from "../core/classical/nuclear_semantic_owner_catalog.mjs?v=20260822-all-operation-layers-216";
import { installClassicalNahuatlIrregularVncGlobals } from "../core/classical/irregular_vnc.mjs?v=20260818-lesson29-groups10-12-357";
...
import { installClassicalNahuatlVncDerivationEvaluatorGlobals } from "../core/classical/vnc_derivation_evaluator.mjs?v=20260818-lesson29-groups10-12-357";
...
import { installClassicalNahuatlSupplementationGlobals } from "../core/sentence/supplementation.mjs?v=20260822-all-operation-layers-216";
...
import { installUiEventsGlobals } from "../ui/events/events.mjs?v=20260818-lesson29-groups10-12-357";
