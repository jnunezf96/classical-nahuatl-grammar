import { installClassicalNahuatlVncApplicationGlobals } from "../application/classical/vnc_application.mjs?v=20260822-vnc-capability-inheritance-221";
import { installClassicalNahuatlNncApplicationGlobals } from "../application/classical/nnc_application.mjs?v=20260822-vnc-capability-inheritance-221";
import { installClassicalGrammarApplicationGlobals } from "../application/classical/grammar_application.mjs?v=20260822-vnc-capability-inheritance-221";
...
import { installClassicalNahuatlSourceStemInventoryGlobals } from "../core/classical/source_stem_inventory.mjs?v=20260818-lesson29-groups10-12-357";
...
import { installClassicalNahuatlNncLayerEvaluatorGlobals } from "../core/classical/nnc_layer_evaluator.mjs?v=20260822-vnc-capability-inheritance-221";
import { installClassicalNahuatlNominalConstructionGlobals } from "../core/classical/nominal_construction.mjs?v=20260822-vnc-capability-inheritance-221";
import { installClassicalNahuatlDeverbalNncGlobals } from "../core/classical/nnc_lessons35_39_closure.mjs?v=20260822-vnc-capability-inheritance-221";
...
import { installClassicalNahuatlAdverbialNuclearGlobals } from "../core/classical/adverbial_nuclear_grammar.mjs?v=20260822-vnc-capability-inheritance-221";
...
import { installClassicalNahuatlVncLayerEvaluatorGlobals } from "../core/classical/vnc_layer_evaluator.mjs?v=20260822-vnc-capability-inheritance-221";
import { installClassicalNahuatlVncClosureGlobals } from "../core/classical/vnc_lessons27_29_33_closure.mjs?v=20260822-vnc-capability-inheritance-221";
...
import { installClassicalNuclearSemanticOwnersGlobals } from "../core/classical/nuclear_semantic_owner_catalog.mjs?v=20260822-vnc-capability-inheritance-221";
import { installClassicalNahuatlIrregularVncGlobals } from "../core/classical/irregular_vnc.mjs?v=20260822-vnc-capability-inheritance-221";
...
import { installClassicalNahuatlVncDerivationEvaluatorGlobals } from "../core/classical/vnc_derivation_evaluator.mjs?v=20260822-vnc-capability-inheritance-221";
...
import { installClassicalNahuatlSupplementationGlobals } from "../core/sentence/supplementation.mjs?v=20260822-vnc-capability-inheritance-221";
...
import { installUiEventsGlobals } from "../ui/events/events.mjs?v=20260822-vnc-capability-inheritance-221";
...
import { isRuntimeCrossModuleCapability } from "./runtime_capability_contract.mjs?v=20260818-lesson29-groups10-12-357";
