import { installClassicalNahuatlVncApplicationGlobals } from "../application/classical/vnc_application.mjs?v=20260825-capability-closure-333";
...
import { installClassicalGrammarApplicationGlobals } from "../application/classical/grammar_application.mjs?v=20260825-capability-closure-333";
import { installClassicalNahuatlFormationResultBindingGlobals } from "../application/classical/formation_result_binding.mjs?v=20260825-capability-closure-333";
import { installClassicalGrammarWorkspaceHistoryGlobals } from "../application/classical/grammar_workspace_history.mjs?v=20260825-capability-closure-333";
import { installClassicalCapabilityClosureAtlasGlobals } from "../ui/diagnostics/classical_capability_closure_atlas.mjs?v=20260825-capability-closure-333";
import { installClassicalClauseRelationControllerGlobals } from "../application/classical/clause_relation_controller.mjs?v=20260825-capability-closure-333";
...
import { installClassicalNahuatlParticlesGlobals } from "../core/classical/particle_grammar.mjs?v=20260825-capability-closure-333";
...
import { installClassicalNahuatlDeverbalNncGlobals } from "../core/classical/nnc_lessons35_39_closure.mjs?v=20260825-capability-closure-333";
...
import { installClassicalNahuatlAdverbialNuclearGlobals } from "../core/classical/adverbial_nuclear_grammar.mjs?v=20260825-capability-closure-333";
...
import { installClassicalNahuatlDenominalVncGrammarGlobals } from "../core/classical/denominal_vnc_grammar.mjs?v=20260825-capability-closure-333";
...
import { installClassicalNuclearSemanticOwnersGlobals } from "../core/classical/nuclear_semantic_owner_catalog.mjs?v=20260825-capability-closure-333";
...
import { installClassicalNahuatlVerbstemClassesGlobals } from "../core/classical/verbstem_classes.mjs?v=20260825-capability-closure-333";
...
import { installPersonalNameNncGlobals } from "../core/nnc/names/names.mjs?v=20260825-capability-closure-333";
import { installNncGlobals } from "../core/nnc/nnc.mjs?v=20260818-lesson29-groups10-12-357";
import { installPlaceGentilicNncGlobals } from "../core/nnc/place_gentilic/place_gentilic.mjs?v=20260825-capability-closure-333";
...
import { installUiEventsGlobals } from "../ui/events/events.mjs?v=20260825-capability-closure-333";
...
import { isRuntimeCrossModuleCapability } from "./runtime_capability_contract.mjs?v=20260825-capability-closure-333";
